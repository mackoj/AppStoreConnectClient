...
public struct ASCBetaGroupsResponse: AppStoreConnectBaseModel {

    public var data: [ASCBetaGroup]
    ...
    public init(data: [ASCBetaGroup], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
