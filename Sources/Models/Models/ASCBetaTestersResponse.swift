...
public struct ASCBetaTestersResponse: AppStoreConnectBaseModel {

    public var data: [ASCBetaTester]
    ...
    public init(data: [ASCBetaTester], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
