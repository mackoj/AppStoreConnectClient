...
public struct ASCAppInfosResponse: AppStoreConnectBaseModel {

    public var data: [ASCAppInfo]
    ...
    public init(data: [ASCAppInfo], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
