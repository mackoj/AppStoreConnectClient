...
public struct ASCBuildsResponse: AppStoreConnectBaseModel {

    public var data: [ASCBuild]
    ...
    public init(data: [ASCBuild], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
