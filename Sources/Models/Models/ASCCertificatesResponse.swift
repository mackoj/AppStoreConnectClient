...
public struct ASCCertificatesResponse: AppStoreConnectBaseModel {
    ...
    public init(data: [ASCCertificate], links: ASCPagedDocumentLinks, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
        self.meta = meta
    }
