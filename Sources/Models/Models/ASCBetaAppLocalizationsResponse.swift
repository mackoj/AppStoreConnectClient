...
public struct ASCBetaAppLocalizationsResponse: AppStoreConnectBaseModel {

    public var data: [ASCBetaAppLocalization]
    ...
    public init(data: [ASCBetaAppLocalization], links: ASCPagedDocumentLinks, included: [ASCApp]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
