...
public struct ASCBundleIdsResponse: AppStoreConnectBaseModel {

    public var data: [ASCBundleId]
    ...
    public init(data: [ASCBundleId], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
