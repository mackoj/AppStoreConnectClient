...
public struct ASCUserInvitationsResponse: AppStoreConnectBaseModel {

    public var data: [ASCUserInvitation]
    ...
    public init(data: [ASCUserInvitation], links: ASCPagedDocumentLinks, included: [ASCApp]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
