...
public struct ASCBetaAppReviewDetailsResponse: AppStoreConnectBaseModel {

    public var data: [ASCBetaAppReviewDetail]
    ...
    public init(data: [ASCBetaAppReviewDetail], links: ASCPagedDocumentLinks, included: [ASCApp]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
