...
public struct ASCAppsResponse: AppStoreConnectBaseModel {

    public var data: [ASCApp]
    ...
    public init(data: [ASCApp], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
