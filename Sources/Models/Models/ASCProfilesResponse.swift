...
public struct ASCProfilesResponse: AppStoreConnectBaseModel {

    public var data: [ASCProfile]
    ...
    public init(data: [ASCProfile], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
