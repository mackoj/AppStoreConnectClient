...
public struct ASCUserInvitation: AppStoreConnectBaseModel {
  ...
  public struct Attributes: AppStoreConnectBaseModel {
    ...
    public init(
      allAppsVisible: Bool? = nil, email: String? = nil, expirationDate: DateTime? = nil,
      firstName: String? = nil, lastName: String? = nil, provisioningAllowed: Bool? = nil,
      roles: [ASCUserRole]? = nil
    ) {
