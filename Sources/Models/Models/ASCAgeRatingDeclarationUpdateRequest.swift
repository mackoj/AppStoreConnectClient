    ...
    public struct Attributes: AppStoreConnectBaseModel {
      ...
      public init(
        ...
        violenceRealisticProlongedGraphicOrSadistic:
          ASCViolenceRealisticProlongedGraphicOrSadistic? = nil
      ) {
      ...
      public init(from decoder: Decoder) throws {
        ...
        medicalOrTreatmentInformation = try container.decodeIfPresent(
          "medicalOrTreatmentInformation")
        profanityOrCrudeHumor = try container.decodeIfPresent("profanityOrCrudeHumor")
        sexualContentGraphicAndNudity = try container.decodeIfPresent(
