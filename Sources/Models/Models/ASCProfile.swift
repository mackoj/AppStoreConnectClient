...
public struct ASCProfile: AppStoreConnectBaseModel {
  ...
  public struct Attributes: AppStoreConnectBaseModel {
    ...
    public init(
      createdDate: DateTime? = nil, expirationDate: DateTime? = nil, name: String? = nil,
      platform: ASCBundleIdPlatform? = nil, profileContent: String? = nil,
      profileState: ASCProfileState? = nil, profileType: ASCProfileType? = nil, uuid: String? = nil
    ) {
  ...
  public struct Relationships: AppStoreConnectBaseModel {
    ...
    public init(
      bundleId: BundleId? = nil, certificates: Certificates? = nil, devices: Devices? = nil
    ) {
