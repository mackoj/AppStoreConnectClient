...
public struct ASCAppPricePointsResponse: AppStoreConnectBaseModel {

    public var data: [ASCAppPricePoint]
    ...
    public init(data: [ASCAppPricePoint], links: ASCPagedDocumentLinks, included: [ASCTerritory]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
