...
public struct ASCPreReleaseVersionsResponse: AppStoreConnectBaseModel {
    ...
    public init(data: [ASCPrereleaseVersion], links: ASCPagedDocumentLinks, included: [Included]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
