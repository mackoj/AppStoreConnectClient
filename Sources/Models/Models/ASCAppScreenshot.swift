...
public struct ASCAppScreenshot: AppStoreConnectBaseModel {
    ...
    public struct Attributes: AppStoreConnectBaseModel {
        ...
        public init(assetDeliveryState: ASCAppMediaAssetState? = nil, assetToken: String? = nil, assetType: String? = nil, fileName: String? = nil, fileSize: Int? = nil, imageAsset: ASCImageAsset? = nil, sourceFileChecksum: String? = nil, uploadOperations: [ASCUploadOperation]? = nil) {
