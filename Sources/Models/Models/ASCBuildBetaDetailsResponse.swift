...
public struct ASCBuildBetaDetailsResponse: AppStoreConnectBaseModel {

    public var data: [ASCBuildBetaDetail]
    ...
    public init(data: [ASCBuildBetaDetail], links: ASCPagedDocumentLinks, included: [ASCBuild]? = nil, meta: ASCPagingInformation? = nil) {
        self.data = data
        self.links = links
