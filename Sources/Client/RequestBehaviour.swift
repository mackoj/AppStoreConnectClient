...
#if canImport(AppStoreConnectRequests)
...
public protocol RequestBehaviour {
  ...
  func validate(
    request: AnyRequest, urlRequest: URLRequest,
    complete: @escaping (RequestValidationResult) -> Void)
...
extension RequestBehaviour {
  public func modifyRequest(request: AnyRequest, urlRequest: URLRequest) -> URLRequest {
    return urlRequest
  }
  ...
  public func beforeSend(request: AnyRequest) {}
  public func onSuccess(request: AnyRequest, result: Any) {}
  public func onFailure(request: AnyRequest, error: APIClientError) {}
  public func onResponse(request: AnyRequest, response: AnyResponse) {}
}
