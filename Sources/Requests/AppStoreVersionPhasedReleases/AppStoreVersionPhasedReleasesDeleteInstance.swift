...
extension AppStoreConnect.AppStoreVersionPhasedReleases {
    ...
    public enum AppStoreVersionPhasedReleasesDeleteInstance {

        public static let service = APIService<Response>(id: "appStoreVersionPhasedReleases-delete_instance", tag: "AppStoreVersionPhasedReleases", method: "DELETE", path: "/v1/appStoreVersionPhasedReleases/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionPhasedReleasesDeleteInstance.service)
            }
