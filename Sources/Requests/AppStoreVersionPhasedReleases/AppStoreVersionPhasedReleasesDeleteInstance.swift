...
extension AppStoreConnect.AppStoreVersionPhasedReleases {
  ...
  public enum AppStoreVersionPhasedReleasesDeleteInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersionPhasedReleases-delete_instance", tag: "AppStoreVersionPhasedReleases",
      method: "DELETE", path: "/v1/appStoreVersionPhasedReleases/{id}", hasBody: false,
