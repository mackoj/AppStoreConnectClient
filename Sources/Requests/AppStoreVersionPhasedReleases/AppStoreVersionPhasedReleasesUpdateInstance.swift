...
extension AppStoreConnect.AppStoreVersionPhasedReleases {
  ...
  public enum AppStoreVersionPhasedReleasesUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersionPhasedReleases-update_instance", tag: "AppStoreVersionPhasedReleases",
      method: "PATCH", path: "/v1/appStoreVersionPhasedReleases/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppStoreVersionPhasedReleaseUpdateRequest, options: Options,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppStoreVersionPhasedReleaseResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppStoreVersionPhasedReleaseResponse.self, from: data))
