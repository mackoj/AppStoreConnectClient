...
extension AppStoreConnect.BetaBuildLocalizations {
    ...
    public enum BetaBuildLocalizationsBuildGetToOneRelated {

        public static let service = APIService<Response>(id: "betaBuildLocalizations-build-get_to_one_related", tag: "BetaBuildLocalizations", method: "GET", path: "/v1/betaBuildLocalizations/{id}/build", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaBuildLocalizationsBuildGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
