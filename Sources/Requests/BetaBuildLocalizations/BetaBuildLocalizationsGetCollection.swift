...
extension AppStoreConnect.BetaBuildLocalizations {
  ...
  public enum BetaBuildLocalizationsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "betaBuildLocalizations-get_collection", tag: "BetaBuildLocalizations", method: "GET",
      path: "/v1/betaBuildLocalizations", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterlocale: [String]? = nil, filterbuild: [String]? = nil,
          fieldsbetaBuildLocalizations: [ASCFieldsbetaBuildLocalizations]? = nil, limit: Int? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          filterlocale: filterlocale, filterbuild: filterbuild,
          fieldsbetaBuildLocalizations: fieldsbetaBuildLocalizations, limit: limit,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaBuildLocalizationsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaBuildLocalizationsResponse.self, from: data))
