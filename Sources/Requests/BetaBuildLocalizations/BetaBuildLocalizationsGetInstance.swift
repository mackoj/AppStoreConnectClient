...
extension AppStoreConnect.BetaBuildLocalizations {
    ...
    public enum BetaBuildLocalizationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaBuildLocalizations-get_instance", tag: "BetaBuildLocalizations", method: "GET", path: "/v1/betaBuildLocalizations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaBuildLocalizations: [ASCFieldsbetaBuildLocalizations]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaBuildLocalizations: [ASCFieldsbetaBuildLocalizations]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
