...
extension AppStoreConnect.BetaBuildLocalizations {
    ...
    public enum BetaBuildLocalizationsDeleteInstance {

        public static let service = APIService<Response>(id: "betaBuildLocalizations-delete_instance", tag: "BetaBuildLocalizations", method: "DELETE", path: "/v1/betaBuildLocalizations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaBuildLocalizationsDeleteInstance.service)
            }
