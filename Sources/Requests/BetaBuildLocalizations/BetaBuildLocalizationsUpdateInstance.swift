...
extension AppStoreConnect.BetaBuildLocalizations {
  ...
  public enum BetaBuildLocalizationsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaBuildLocalizations-update_instance", tag: "BetaBuildLocalizations", method: "PATCH",
      path: "/v1/betaBuildLocalizations/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaBuildLocalizationUpdateRequest, options: Options,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaBuildLocalizationResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaBuildLocalizationResponse.self, from: data))
