...
extension AppStoreConnect.BetaBuildLocalizations {
  ...
  public enum BetaBuildLocalizationsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaBuildLocalizations-create_instance", tag: "BetaBuildLocalizations", method: "POST",
      path: "/v1/betaBuildLocalizations", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCBetaBuildLocalizationResponse.self, from: data))
