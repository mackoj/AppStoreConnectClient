...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersBuildsDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-builds-delete_to_many_relationship", tag: "BetaTesters", method: "DELETE",
      path: "/v1/betaTesters/{id}/relationships/builds", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaTesterBuildsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
