...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersBetaGroupsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-betaGroups-get_to_many_related", tag: "BetaTesters", method: "GET",
      path: "/v1/betaTesters/{id}/betaGroups", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, limit: Int? = nil
      ) {
