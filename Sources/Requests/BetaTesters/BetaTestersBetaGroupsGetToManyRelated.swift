...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersBetaGroupsGetToManyRelated {

        public static let service = APIService<Response>(id: "betaTesters-betaGroups-get_to_many_related", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters/{id}/betaGroups", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaTestersBetaGroupsGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsbetaGroups: fieldsbetaGroups, limit: limit)
