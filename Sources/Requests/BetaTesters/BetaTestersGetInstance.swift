...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-get_instance", tag: "BetaTesters", method: "GET",
      path: "/v1/betaTesters/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil,
      ...
      public convenience init(
        id: String, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, include: [ASCInclude]? = nil,
        fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil,
        fieldsapps: [ASCFieldsapps]? = nil, limitapps: Int? = nil, limitbetaGroups: Int? = nil,
        limitbuilds: Int? = nil
      ) {
        let options = Options(
          id: id, fieldsbetaTesters: fieldsbetaTesters, include: include,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      /** Single BetaTester */
      case status200(ASCBetaTesterResponse)
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(ASCBetaTesterResponse.self, from: data))
