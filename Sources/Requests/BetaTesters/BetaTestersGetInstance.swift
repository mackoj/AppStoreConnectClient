...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaTesters-get_instance", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, include: [ASCInclude]? = nil, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitapps: Int? = nil, limitbetaGroups: Int? = nil, limitbuilds: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, include: [ASCInclude]? = nil, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitapps: Int? = nil, limitbetaGroups: Int? = nil, limitbuilds: Int? = nil) {
