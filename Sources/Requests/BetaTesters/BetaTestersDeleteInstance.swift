...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "betaTesters-delete_instance", tag: "BetaTesters", method: "DELETE", path: "/v1/betaTesters/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
