...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersAppsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-apps-get_to_many_relationship", tag: "BetaTesters", method: "GET",
      path: "/v1/betaTesters/{id}/relationships/apps", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaTesterAppsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaTesterAppsLinkagesResponse.self, from: data))
