...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersAppsGetToManyRelated {

        public static let service = APIService<Response>(id: "betaTesters-apps-get_to_many_related", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters/{id}/apps", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaTestersAppsGetToManyRelated.service)
            }
