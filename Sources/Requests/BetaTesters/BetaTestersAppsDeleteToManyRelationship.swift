...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersAppsDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-apps-delete_to_many_relationship", tag: "BetaTesters", method: "DELETE",
      path: "/v1/betaTesters/{id}/relationships/apps", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaTesterAppsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
