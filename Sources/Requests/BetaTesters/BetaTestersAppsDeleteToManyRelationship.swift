...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersAppsDeleteToManyRelationship {

        public static let service = APIService<Response>(id: "betaTesters-apps-delete_to_many_relationship", tag: "BetaTesters", method: "DELETE", path: "/v1/betaTesters/{id}/relationships/apps", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBetaTesterAppsLinkagesRequest

            public init(body: ASCBetaTesterAppsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BetaTestersAppsDeleteToManyRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBetaTesterAppsLinkagesRequest) {
