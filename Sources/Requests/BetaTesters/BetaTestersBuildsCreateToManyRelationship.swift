...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersBuildsCreateToManyRelationship {

        public static let service = APIService<Response>(id: "betaTesters-builds-create_to_many_relationship", tag: "BetaTesters", method: "POST", path: "/v1/betaTesters/{id}/relationships/builds", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ASCBetaTesterBuildsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: BetaTestersBuildsCreateToManyRelationship.service) { defaultEncoder in
