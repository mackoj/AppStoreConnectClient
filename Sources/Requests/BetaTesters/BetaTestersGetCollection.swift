...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaTesters-get_collection", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filteremail: [String]? = nil, filterfirstName: [String]? = nil, filterinviteType: [ASCFilterinviteType]? = nil, filterlastName: [String]? = nil, filterapps: [String]? = nil, filterbetaGroups: [String]? = nil, filterbuilds: [String]? = nil, sort: [ASCSort]? = nil, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitapps: Int? = nil, limitbetaGroups: Int? = nil, limitbuilds: Int? = nil) {
            ...
            public convenience init(filteremail: [String]? = nil, filterfirstName: [String]? = nil, filterinviteType: [ASCFilterinviteType]? = nil, filterlastName: [String]? = nil, filterapps: [String]? = nil, filterbetaGroups: [String]? = nil, filterbuilds: [String]? = nil, sort: [ASCSort]? = nil, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitapps: Int? = nil, limitbetaGroups: Int? = nil, limitbuilds: Int? = nil) {
