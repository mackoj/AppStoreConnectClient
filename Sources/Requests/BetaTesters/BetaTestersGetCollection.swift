...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-get_collection", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters",
      hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: [])
    )

    /** filter by attribute 'inviteType' */
    public enum ASCFilterinviteType: String, Codable, Equatable, CaseIterable {
      case email = "EMAIL"
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        /** filter by attribute 'inviteType' */
        public var filterinviteType: [ASCFilterinviteType]?
        ...
        public init(
          filteremail: [String]? = nil, filterfirstName: [String]? = nil,
          filterinviteType: [ASCFilterinviteType]? = nil, filterlastName: [String]? = nil,
          filterapps: [String]? = nil, filterbetaGroups: [String]? = nil,
          filterbuilds: [String]? = nil, sort: [ASCSort]? = nil,
          fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, limit: Int? = nil,
          include: [ASCInclude]? = nil, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil,
          fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsapps: [ASCFieldsapps]? = nil,
          limitapps: Int? = nil, limitbetaGroups: Int? = nil, limitbuilds: Int? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filteremail: filteremail, filterfirstName: filterfirstName,
          filterinviteType: filterinviteType, filterlastName: filterlastName,
          filterapps: filterapps, filterbetaGroups: filterbetaGroups, filterbuilds: filterbuilds,
          sort: sort, fieldsbetaTesters: fieldsbetaTesters, limit: limit, include: include,
          fieldsbetaGroups: fieldsbetaGroups, fieldsbuilds: fieldsbuilds, fieldsapps: fieldsapps,
          limitapps: limitapps, limitbetaGroups: limitbetaGroups, limitbuilds: limitbuilds)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterinviteType = options.filterinviteType?.encode().map({ String(describing: $0) })
          .joined(separator: ",")
        {
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      public typealias SuccessType = ASCBetaTestersResponse

      /** List of BetaTesters */
      case status200(ASCBetaTestersResponse)
      ...
      public var success: ASCBetaTestersResponse? {
        switch self {
      ...
      public var responseResult: APIResponseResult<ASCBetaTestersResponse, ASCErrorResponse> {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(ASCBetaTestersResponse.self, from: data))
