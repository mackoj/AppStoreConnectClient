...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersBetaGroupsCreateToManyRelationship {

        public static let service = APIService<Response>(id: "betaTesters-betaGroups-create_to_many_relationship", tag: "BetaTesters", method: "POST", path: "/v1/betaTesters/{id}/relationships/betaGroups", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ASCBetaTesterBetaGroupsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: BetaTestersBetaGroupsCreateToManyRelationship.service) { defaultEncoder in
