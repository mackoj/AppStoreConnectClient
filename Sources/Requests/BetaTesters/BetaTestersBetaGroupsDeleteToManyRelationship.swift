...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersBetaGroupsDeleteToManyRelationship {

        public static let service = APIService<Response>(id: "betaTesters-betaGroups-delete_to_many_relationship", tag: "BetaTesters", method: "DELETE", path: "/v1/betaTesters/{id}/relationships/betaGroups", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBetaTesterBetaGroupsLinkagesRequest

            public init(body: ASCBetaTesterBetaGroupsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BetaTestersBetaGroupsDeleteToManyRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBetaTesterBetaGroupsLinkagesRequest) {
