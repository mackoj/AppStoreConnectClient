...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersBuildsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-builds-get_to_many_relationship", tag: "BetaTesters", method: "GET",
      path: "/v1/betaTesters/{id}/relationships/builds", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaTesterBuildsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCBetaTesterBuildsLinkagesResponse.self, from: data))
