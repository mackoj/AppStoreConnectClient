...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersCreateInstance {
        ...
        public static let service = APIService<Response>(id: "betaTesters-create_instance", tag: "BetaTesters", method: "POST", path: "/v1/betaTesters", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
