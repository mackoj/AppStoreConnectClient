...
extension AppStoreConnect.BetaTesters {
  ...
  public enum BetaTestersBetaGroupsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaTesters-betaGroups-get_to_many_relationship", tag: "BetaTesters", method: "GET",
      path: "/v1/betaTesters/{id}/relationships/betaGroups", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaTesterBetaGroupsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCBetaTesterBetaGroupsLinkagesResponse.self, from: data))
