...
extension AppStoreConnect.AppPrices {
    ...
    public enum AppPricesGetInstance {
        ...
        public static let service = APIService<Response>(id: "appPrices-get_instance", tag: "AppPrices", method: "GET", path: "/v1/appPrices/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPrices: [ASCFieldsappPrices]? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPrices: [ASCFieldsappPrices]? = nil, include: [ASCInclude]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPriceResponse

            /** Single AppPrice */
            case status200(ASCAppPriceResponse)
            ...
            public var success: ASCAppPriceResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPriceResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPriceResponse.self, from: data))
