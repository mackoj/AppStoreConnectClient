...
public class APIRequest<ResponseType: APIResponseValue> {
  ...
  public init(
    service: APIService<ResponseType>,
...
extension URL {
  public var resolvingAgainstBaseURL: Bool { return (self.baseURL != nil) }
}

// Create URLRequest
extension APIRequest {

  private func encodeURLParameters(_ urlRequest: URLRequest, with parameters: [String: Any]?) throws
    -> URLRequest
  {
    ...
    if var urlComponents = URLComponents(
      url: url, resolvingAgainstBaseURL: url.resolvingAgainstBaseURL), !parameters.isEmpty
    {
  ...
  private func encodeFormParam(_ urlRequest: URLRequest, with parameters: [String: Any]?) throws
    -> URLRequest
  {
    var urlRequest = urlRequest
    guard let parameters = parameters else { return urlRequest }
