...
extension AppStoreConnect.Users {
    ...
    public enum UsersUpdateInstance {

        public static let service = APIService<Response>(id: "users-update_instance", tag: "Users", method: "PATCH", path: "/v1/users/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCUserUpdateRequest

            public init(body: ASCUserUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: UsersUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCUserUpdateRequest) {
