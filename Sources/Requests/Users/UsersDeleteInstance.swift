...
extension AppStoreConnect.Users {
    ...
    public enum UsersDeleteInstance {

        public static let service = APIService<Response>(id: "users-delete_instance", tag: "Users", method: "DELETE", path: "/v1/users/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UsersDeleteInstance.service)
            }
