...
extension AppStoreConnect.Users {
    ...
    public enum UsersVisibleAppsDeleteToManyRelationship {

        public static let service = APIService<Response>(id: "users-visibleApps-delete_to_many_relationship", tag: "Users", method: "DELETE", path: "/v1/users/{id}/relationships/visibleApps", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCUserVisibleAppsLinkagesRequest

            public init(body: ASCUserVisibleAppsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: UsersVisibleAppsDeleteToManyRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCUserVisibleAppsLinkagesRequest) {
