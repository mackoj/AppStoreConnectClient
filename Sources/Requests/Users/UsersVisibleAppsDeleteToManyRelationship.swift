...
extension AppStoreConnect.Users {
  ...
  public enum UsersVisibleAppsDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "users-visibleApps-delete_to_many_relationship", tag: "Users", method: "DELETE",
      path: "/v1/users/{id}/relationships/visibleApps", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCUserVisibleAppsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
