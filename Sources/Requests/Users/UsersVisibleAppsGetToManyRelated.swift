...
extension AppStoreConnect.Users {
    ...
    public enum UsersVisibleAppsGetToManyRelated {

        public static let service = APIService<Response>(id: "users-visibleApps-get_to_many_related", tag: "Users", method: "GET", path: "/v1/users/{id}/visibleApps", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UsersVisibleAppsGetToManyRelated.service)
            }
