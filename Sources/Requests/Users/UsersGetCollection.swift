...
extension AppStoreConnect.Users {
  ...
  public enum UsersGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "users-get_collection", tag: "Users", method: "GET", path: "/v1/users", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterroles: [ASCFilterroles]? = nil, filterusername: [String]? = nil,
          filtervisibleApps: [String]? = nil, sort: [ASCSort]? = nil,
          fieldsusers: [ASCFieldsusers]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil,
          fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filterroles: filterroles, filterusername: filterusername,
          filtervisibleApps: filtervisibleApps, sort: sort, fieldsusers: fieldsusers, limit: limit,
          include: include, fieldsapps: fieldsapps, limitvisibleApps: limitvisibleApps)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let fieldsusers = options.fieldsusers?.encode().map({ String(describing: $0) }).joined(
          separator: ",")
        {
