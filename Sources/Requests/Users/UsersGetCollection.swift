...
extension AppStoreConnect.Users {
    ...
    public enum UsersGetCollection {
        ...
        public static let service = APIService<Response>(id: "users-get_collection", tag: "Users", method: "GET", path: "/v1/users", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public enum ASCFieldsusers: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** the fields to include for returned resources of type users */
                public var fieldsusers: [ASCFieldsusers]?
                ...
                public init(filterroles: [ASCFilterroles]? = nil, filterusername: [String]? = nil, filtervisibleApps: [String]? = nil, sort: [ASCSort]? = nil, fieldsusers: [ASCFieldsusers]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil) {
            ...
            public convenience init(filterroles: [ASCFilterroles]? = nil, filterusername: [String]? = nil, filtervisibleApps: [String]? = nil, sort: [ASCSort]? = nil, fieldsusers: [ASCFieldsusers]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCUsersResponse

            /** List of Users */
            case status200(ASCUsersResponse)
            ...
            public var success: ASCUsersResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCUsersResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCUsersResponse.self, from: data))
