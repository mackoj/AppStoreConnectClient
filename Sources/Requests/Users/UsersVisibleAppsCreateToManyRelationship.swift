...
extension AppStoreConnect.Users {
    ...
    public enum UsersVisibleAppsCreateToManyRelationship {

        public static let service = APIService<Response>(id: "users-visibleApps-create_to_many_relationship", tag: "Users", method: "POST", path: "/v1/users/{id}/relationships/visibleApps", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ASCUserVisibleAppsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: UsersVisibleAppsCreateToManyRelationship.service) { defaultEncoder in
