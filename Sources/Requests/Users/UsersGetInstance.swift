...
extension AppStoreConnect.Users {
    ...
    public enum UsersGetInstance {

        public static let service = APIService<Response>(id: "users-get_instance", tag: "Users", method: "GET", path: "/v1/users/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsusers: [ASCFieldsusers]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: UsersGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsusers: [ASCFieldsusers]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil) {
                let options = Options(id: id, fieldsusers: fieldsusers, include: include, fieldsapps: fieldsapps, limitvisibleApps: limitvisibleApps)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCUserResponse

            /** Single User */
            case status200(ASCUserResponse)
            ...
            public var success: ASCUserResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCUserResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCUserResponse.self, from: data))
