...
extension AppStoreConnect.Users {
  ...
  public enum UsersVisibleAppsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "users-visibleApps-get_to_many_relationship", tag: "Users", method: "GET",
      path: "/v1/users/{id}/relationships/visibleApps", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCUserVisibleAppsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCUserVisibleAppsLinkagesResponse.self, from: data))
