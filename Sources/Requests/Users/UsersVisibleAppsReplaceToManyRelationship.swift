...
extension AppStoreConnect.Users {
    ...
    public enum UsersVisibleAppsReplaceToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "users-visibleApps-replace_to_many_relationship", tag: "Users", method: "PATCH", path: "/v1/users/{id}/relationships/visibleApps", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
