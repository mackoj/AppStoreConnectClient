...
extension AppStoreConnect.AppStoreVersionSubmissions {
    ...
    public enum AppStoreVersionSubmissionsDeleteInstance {

        public static let service = APIService<Response>(id: "appStoreVersionSubmissions-delete_instance", tag: "AppStoreVersionSubmissions", method: "DELETE", path: "/v1/appStoreVersionSubmissions/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionSubmissionsDeleteInstance.service)
            }
