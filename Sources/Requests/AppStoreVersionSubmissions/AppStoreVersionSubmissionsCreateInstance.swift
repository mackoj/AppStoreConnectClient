...
extension AppStoreConnect.AppStoreVersionSubmissions {
  ...
  public enum AppStoreVersionSubmissionsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersionSubmissions-create_instance", tag: "AppStoreVersionSubmissions",
      method: "POST", path: "/v1/appStoreVersionSubmissions", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppStoreVersionSubmissionResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 201:
          self = try .status201(
            decoder.decode(ASCAppStoreVersionSubmissionResponse.self, from: data))
