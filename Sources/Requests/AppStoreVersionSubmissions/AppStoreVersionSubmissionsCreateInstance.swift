...
extension AppStoreConnect.AppStoreVersionSubmissions {

    public enum AppStoreVersionSubmissionsCreateInstance {

        public static let service = APIService<Response>(id: "appStoreVersionSubmissions-create_instance", tag: "AppStoreVersionSubmissions", method: "POST", path: "/v1/appStoreVersionSubmissions", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppStoreVersionSubmissionCreateRequest

            public init(body: ASCAppStoreVersionSubmissionCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: AppStoreVersionSubmissionsCreateInstance.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppStoreVersionSubmissionResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppStoreVersionSubmissionResponse.self, from: data))
