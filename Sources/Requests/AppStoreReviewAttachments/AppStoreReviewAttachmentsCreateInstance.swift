...
extension AppStoreConnect.AppStoreReviewAttachments {
    ...
    public enum AppStoreReviewAttachmentsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewAttachments-create_instance", tag: "AppStoreReviewAttachments", method: "POST", path: "/v1/appStoreReviewAttachments", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppStoreReviewAttachmentCreateRequest

            public init(body: ASCAppStoreReviewAttachmentCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppStoreReviewAttachmentResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppStoreReviewAttachmentResponse.self, from: data))
