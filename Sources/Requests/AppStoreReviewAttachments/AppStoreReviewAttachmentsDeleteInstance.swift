...
extension AppStoreConnect.AppStoreReviewAttachments {
    ...
    public enum AppStoreReviewAttachmentsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewAttachments-delete_instance", tag: "AppStoreReviewAttachments", method: "DELETE", path: "/v1/appStoreReviewAttachments/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
