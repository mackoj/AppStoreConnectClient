...
extension AppStoreConnect.AppStoreReviewAttachments {
  ...
  public enum AppStoreReviewAttachmentsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreReviewAttachments-update_instance", tag: "AppStoreReviewAttachments",
      method: "PATCH", path: "/v1/appStoreReviewAttachments/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppStoreReviewAttachmentUpdateRequest, options: Options,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppStoreReviewAttachmentResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppStoreReviewAttachmentResponse.self, from: data))
