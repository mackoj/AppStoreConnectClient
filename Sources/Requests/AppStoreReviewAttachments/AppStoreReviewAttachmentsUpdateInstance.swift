...
extension AppStoreConnect.AppStoreReviewAttachments {
    ...
    public enum AppStoreReviewAttachmentsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewAttachments-update_instance", tag: "AppStoreReviewAttachments", method: "PATCH", path: "/v1/appStoreReviewAttachments/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppStoreReviewAttachmentUpdateRequest

            public init(body: ASCAppStoreReviewAttachmentUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppStoreReviewAttachmentUpdateRequest) {
