...
extension AppStoreConnect.IdfaDeclarations {
  ...
  public enum IdfaDeclarationsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "idfaDeclarations-update_instance", tag: "IdfaDeclarations", method: "PATCH",
      path: "/v1/idfaDeclarations/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCIdfaDeclarationUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
