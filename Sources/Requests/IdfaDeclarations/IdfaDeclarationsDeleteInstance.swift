...
extension AppStoreConnect.IdfaDeclarations {
    ...
    public enum IdfaDeclarationsDeleteInstance {

        public static let service = APIService<Response>(id: "idfaDeclarations-delete_instance", tag: "IdfaDeclarations", method: "DELETE", path: "/v1/idfaDeclarations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: IdfaDeclarationsDeleteInstance.service)
            }
