...
extension AppStoreConnect.AppPreOrders {
  ...
  public enum AppPreOrdersGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPreOrders-get_instance", tag: "AppPreOrders", method: "GET",
      path: "/v1/appPreOrders/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPreOrders: [ASCFieldsappPreOrders]? = nil,
      ...
      public convenience init(
        id: String, fieldsappPreOrders: [ASCFieldsappPreOrders]? = nil, include: [ASCInclude]? = nil
      ) {
