...
extension AppStoreConnect.AppPreOrders {
    ...
    public enum AppPreOrdersCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreOrders-create_instance", tag: "AppPreOrders", method: "POST", path: "/v1/appPreOrders", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppPreOrderCreateRequest

            public init(body: ASCAppPreOrderCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single AppPreOrder */
            case status201(ASCAppPreOrderResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppPreOrderResponse.self, from: data))
