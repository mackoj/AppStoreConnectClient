...
extension AppStoreConnect.AppPreOrders {
    ...
    public enum AppPreOrdersDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appPreOrders-delete_instance", tag: "AppPreOrders", method: "DELETE", path: "/v1/appPreOrders/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
