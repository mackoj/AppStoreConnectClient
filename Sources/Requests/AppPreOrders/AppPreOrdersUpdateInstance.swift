...
extension AppStoreConnect.AppPreOrders {
  ...
  public enum AppPreOrdersUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPreOrders-update_instance", tag: "AppPreOrders", method: "PATCH",
      path: "/v1/appPreOrders/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppPreOrderUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
