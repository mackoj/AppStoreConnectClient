...
extension AppStoreConnect.AppPreOrders {
    ...
    public enum AppPreOrdersUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreOrders-update_instance", tag: "AppPreOrders", method: "PATCH", path: "/v1/appPreOrders/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppPreOrderUpdateRequest

            public init(body: ASCAppPreOrderUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppPreOrderUpdateRequest) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPreOrderResponse

            /** Single AppPreOrder */
            case status200(ASCAppPreOrderResponse)
            ...
            public var success: ASCAppPreOrderResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPreOrderResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPreOrderResponse.self, from: data))
