...
extension AppStoreConnect.AppScreenshotSets {
  ...
  public enum AppScreenshotSetsAppScreenshotsReplaceToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "appScreenshotSets-appScreenshots-replace_to_many_relationship", tag: "AppScreenshotSets",
      method: "PATCH", path: "/v1/appScreenshotSets/{id}/relationships/appScreenshots",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppScreenshotSetAppScreenshotsLinkagesRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(service: AppScreenshotSetsAppScreenshotsReplaceToManyRelationship.service) {
          defaultEncoder in
