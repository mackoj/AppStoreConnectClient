...
extension AppStoreConnect.AppScreenshotSets {
    ...
    public enum AppScreenshotSetsAppScreenshotsReplaceToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appScreenshotSets-appScreenshots-replace_to_many_relationship", tag: "AppScreenshotSets", method: "PATCH", path: "/v1/appScreenshotSets/{id}/relationships/appScreenshots", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppScreenshotSetAppScreenshotsLinkagesRequest

            public init(body: ASCAppScreenshotSetAppScreenshotsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppScreenshotSetAppScreenshotsLinkagesRequest) {
