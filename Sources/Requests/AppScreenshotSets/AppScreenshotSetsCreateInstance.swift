...
extension AppStoreConnect.AppScreenshotSets {
  ...
  public enum AppScreenshotSetsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appScreenshotSets-create_instance", tag: "AppScreenshotSets", method: "POST",
      path: "/v1/appScreenshotSets", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCAppScreenshotSetResponse.self, from: data))
