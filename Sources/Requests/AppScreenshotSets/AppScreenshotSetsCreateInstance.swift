...
extension AppStoreConnect.AppScreenshotSets {
    ...
    public enum AppScreenshotSetsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshotSets-create_instance", tag: "AppScreenshotSets", method: "POST", path: "/v1/appScreenshotSets", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppScreenshotSetCreateRequest

            public init(body: ASCAppScreenshotSetCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppScreenshotSetResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppScreenshotSetResponse.self, from: data))
