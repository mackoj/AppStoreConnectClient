...
extension AppStoreConnect.AppScreenshotSets {
  ...
  public enum AppScreenshotSetsAppScreenshotsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "appScreenshotSets-appScreenshots-get_to_many_relationship", tag: "AppScreenshotSets",
      method: "GET", path: "/v1/appScreenshotSets/{id}/relationships/appScreenshots",
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppScreenshotSetAppScreenshotsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppScreenshotSetAppScreenshotsLinkagesResponse.self, from: data))
