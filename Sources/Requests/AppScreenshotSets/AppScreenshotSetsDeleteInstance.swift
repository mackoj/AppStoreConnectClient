...
extension AppStoreConnect.AppScreenshotSets {
    ...
    public enum AppScreenshotSetsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshotSets-delete_instance", tag: "AppScreenshotSets", method: "DELETE", path: "/v1/appScreenshotSets/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
