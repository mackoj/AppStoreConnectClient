...
extension AppStoreConnect.BetaGroups {
  ...
  public enum BetaGroupsBetaTestersDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaGroups-betaTesters-delete_to_many_relationship", tag: "BetaGroups", method: "DELETE",
      path: "/v1/betaGroups/{id}/relationships/betaTesters", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaGroupBetaTestersLinkagesRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(service: BetaGroupsBetaTestersDeleteToManyRelationship.service) {
          defaultEncoder in
