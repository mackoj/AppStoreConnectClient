...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsBetaTestersDeleteToManyRelationship {

        public static let service = APIService<Response>(id: "betaGroups-betaTesters-delete_to_many_relationship", tag: "BetaGroups", method: "DELETE", path: "/v1/betaGroups/{id}/relationships/betaTesters", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBetaGroupBetaTestersLinkagesRequest

            public init(body: ASCBetaGroupBetaTestersLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BetaGroupsBetaTestersDeleteToManyRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBetaGroupBetaTestersLinkagesRequest) {
