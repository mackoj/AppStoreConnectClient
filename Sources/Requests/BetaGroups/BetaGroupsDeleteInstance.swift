...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsDeleteInstance {

        public static let service = APIService<Response>(id: "betaGroups-delete_instance", tag: "BetaGroups", method: "DELETE", path: "/v1/betaGroups/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaGroupsDeleteInstance.service)
            }
