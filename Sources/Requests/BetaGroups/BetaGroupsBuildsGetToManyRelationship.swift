...
extension AppStoreConnect.BetaGroups {
  ...
  public enum BetaGroupsBuildsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaGroups-builds-get_to_many_relationship", tag: "BetaGroups", method: "GET",
      path: "/v1/betaGroups/{id}/relationships/builds", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaGroupBuildsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaGroupBuildsLinkagesResponse.self, from: data))
