...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsBuildsCreateToManyRelationship {

        public static let service = APIService<Response>(id: "betaGroups-builds-create_to_many_relationship", tag: "BetaGroups", method: "POST", path: "/v1/betaGroups/{id}/relationships/builds", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ASCBetaGroupBuildsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: BetaGroupsBuildsCreateToManyRelationship.service) { defaultEncoder in
