...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsAppGetToOneRelated {

        public static let service = APIService<Response>(id: "betaGroups-app-get_to_one_related", tag: "BetaGroups", method: "GET", path: "/v1/betaGroups/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaGroupsAppGetToOneRelated.service)
            }
