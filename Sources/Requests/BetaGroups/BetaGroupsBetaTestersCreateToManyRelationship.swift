...
extension AppStoreConnect.BetaGroups {
  ...
  public enum BetaGroupsBetaTestersCreateToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaGroups-betaTesters-create_to_many_relationship", tag: "BetaGroups", method: "POST",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        ...
        super.init(service: BetaGroupsBetaTestersCreateToManyRelationship.service) {
          defaultEncoder in
