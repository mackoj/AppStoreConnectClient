...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsBetaTestersCreateToManyRelationship {

        public static let service = APIService<Response>(id: "betaGroups-betaTesters-create_to_many_relationship", tag: "BetaGroups", method: "POST", path: "/v1/betaGroups/{id}/relationships/betaTesters", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ASCBetaGroupBetaTestersLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: BetaGroupsBetaTestersCreateToManyRelationship.service) { defaultEncoder in
