...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaGroups-get_collection", tag: "BetaGroups", method: "GET", path: "/v1/betaGroups", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterisInternalGroup: [String]? = nil, filtername: [String]? = nil, filterpublicLink: [String]? = nil, filterpublicLinkEnabled: [String]? = nil, filterpublicLinkLimitEnabled: [String]? = nil, filterapp: [String]? = nil, filterbuilds: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitbetaTesters: Int? = nil, limitbuilds: Int? = nil) {
