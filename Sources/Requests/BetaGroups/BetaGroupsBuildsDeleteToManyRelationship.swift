...
extension AppStoreConnect.BetaGroups {
  ...
  public enum BetaGroupsBuildsDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "betaGroups-builds-delete_to_many_relationship", tag: "BetaGroups", method: "DELETE",
      path: "/v1/betaGroups/{id}/relationships/builds", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaGroupBuildsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
