...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsBuildsDeleteToManyRelationship {

        public static let service = APIService<Response>(id: "betaGroups-builds-delete_to_many_relationship", tag: "BetaGroups", method: "DELETE", path: "/v1/betaGroups/{id}/relationships/builds", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBetaGroupBuildsLinkagesRequest

            public init(body: ASCBetaGroupBuildsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BetaGroupsBuildsDeleteToManyRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBetaGroupBuildsLinkagesRequest) {
