...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaGroups-get_instance", tag: "BetaGroups", method: "GET", path: "/v1/betaGroups/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitbetaTesters: Int? = nil, limitbuilds: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitbetaTesters: Int? = nil, limitbuilds: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBetaGroupResponse

            /** Single BetaGroup */
            case status200(ASCBetaGroupResponse)
            ...
            public var success: ASCBetaGroupResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBetaGroupResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaGroupResponse.self, from: data))
