...
extension AppStoreConnect.BetaGroups {
  ...
  public enum BetaGroupsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaGroups-get_instance", tag: "BetaGroups", method: "GET", path: "/v1/betaGroups/{id}",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbetaGroups: [ASCFieldsbetaGroups]? = nil, include: [ASCInclude]? = nil,
          fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil,
          fieldsapps: [ASCFieldsapps]? = nil, limitbetaTesters: Int? = nil, limitbuilds: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaGroups: fieldsbetaGroups, include: include, fieldsbuilds: fieldsbuilds,
          fieldsbetaTesters: fieldsbetaTesters, fieldsapps: fieldsapps,
