...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-delete_instance", tag: "AppScreenshots", method: "DELETE", path: "/v1/appScreenshots/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
