...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-create_instance", tag: "AppScreenshots", method: "POST", path: "/v1/appScreenshots", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppScreenshotCreateRequest

            public init(body: ASCAppScreenshotCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppScreenshotResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppScreenshotResponse.self, from: data))
