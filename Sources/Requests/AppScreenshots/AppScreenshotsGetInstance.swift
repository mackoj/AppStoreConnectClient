...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-get_instance", tag: "AppScreenshots", method: "GET", path: "/v1/appScreenshots/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappScreenshots: [ASCFieldsappScreenshots]? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappScreenshots: [ASCFieldsappScreenshots]? = nil, include: [ASCInclude]? = nil) {
