...
extension AppStoreConnect.AppScreenshots {
  ...
  public enum AppScreenshotsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appScreenshots-get_instance", tag: "AppScreenshots", method: "GET",
      path: "/v1/appScreenshots/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappScreenshots: [ASCFieldsappScreenshots]? = nil,
