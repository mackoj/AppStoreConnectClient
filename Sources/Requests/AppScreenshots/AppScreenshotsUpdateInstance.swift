...
extension AppStoreConnect.AppScreenshots {
  ...
  public enum AppScreenshotsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appScreenshots-update_instance", tag: "AppScreenshots", method: "PATCH",
      path: "/v1/appScreenshots/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppScreenshotUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
