...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-update_instance", tag: "AppScreenshots", method: "PATCH", path: "/v1/appScreenshots/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppScreenshotUpdateRequest

            public init(body: ASCAppScreenshotUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppScreenshotUpdateRequest) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppScreenshotResponse

            /** Single AppScreenshot */
            case status200(ASCAppScreenshotResponse)
            ...
            public var success: ASCAppScreenshotResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppScreenshotResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppScreenshotResponse.self, from: data))
