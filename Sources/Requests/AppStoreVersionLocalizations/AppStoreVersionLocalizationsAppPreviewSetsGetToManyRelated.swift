...
extension AppStoreConnect.AppStoreVersionLocalizations {
    ...
    public enum AppStoreVersionLocalizationsAppPreviewSetsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersionLocalizations-appPreviewSets-get_to_many_related", tag: "AppStoreVersionLocalizations", method: "GET", path: "/v1/appStoreVersionLocalizations/{id}/appPreviewSets", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        /** filter by attribute 'previewType' */
        public enum ASCFilterpreviewType: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** filter by attribute 'previewType' */
                public var filterpreviewType: [ASCFilterpreviewType]?
                ...
                public init(id: String, filterpreviewType: [ASCFilterpreviewType]? = nil, fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, filterpreviewType: [ASCFilterpreviewType]? = nil, fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPreviewSetsResponse

            /** List of related resources */
            case status200(ASCAppPreviewSetsResponse)
            ...
            public var success: ASCAppPreviewSetsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPreviewSetsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPreviewSetsResponse.self, from: data))
