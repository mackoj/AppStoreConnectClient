...
extension AppStoreConnect.AppStoreVersionLocalizations {
  ...
  public enum AppStoreVersionLocalizationsAppPreviewSetsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersionLocalizations-appPreviewSets-get_to_many_related",
      tag: "AppStoreVersionLocalizations", method: "GET",
      path: "/v1/appStoreVersionLocalizations/{id}/appPreviewSets", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, filterpreviewType: [ASCFilterpreviewType]? = nil,
          fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil,
          fieldsappPreviews: [ASCFieldsappPreviews]? = nil,
          fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, limit: Int? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, filterpreviewType: filterpreviewType,
          fieldsappStoreVersionLocalizations: fieldsappStoreVersionLocalizations,
          fieldsappPreviews: fieldsappPreviews, fieldsappPreviewSets: fieldsappPreviewSets,
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterpreviewType = options.filterpreviewType?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
        ...
        if let fieldsappPreviews = options.fieldsappPreviews?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
