...
extension AppStoreConnect.AppStoreVersionLocalizations {
    ...
    public enum AppStoreVersionLocalizationsUpdateInstance {

        public static let service = APIService<Response>(id: "appStoreVersionLocalizations-update_instance", tag: "AppStoreVersionLocalizations", method: "PATCH", path: "/v1/appStoreVersionLocalizations/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppStoreVersionLocalizationUpdateRequest

            public init(body: ASCAppStoreVersionLocalizationUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: AppStoreVersionLocalizationsUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCAppStoreVersionLocalizationUpdateRequest) {
