...
extension AppStoreConnect.AppStoreVersionLocalizations {
  ...
  public enum AppStoreVersionLocalizationsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersionLocalizations-update_instance", tag: "AppStoreVersionLocalizations",
      method: "PATCH", path: "/v1/appStoreVersionLocalizations/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppStoreVersionLocalizationUpdateRequest, options: Options,
