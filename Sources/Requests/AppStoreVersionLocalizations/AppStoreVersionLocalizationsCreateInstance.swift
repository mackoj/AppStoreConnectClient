...
extension AppStoreConnect.AppStoreVersionLocalizations {
    ...
    public enum AppStoreVersionLocalizationsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersionLocalizations-create_instance", tag: "AppStoreVersionLocalizations", method: "POST", path: "/v1/appStoreVersionLocalizations", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppStoreVersionLocalizationCreateRequest

            public init(body: ASCAppStoreVersionLocalizationCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppStoreVersionLocalizationResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppStoreVersionLocalizationResponse.self, from: data))
