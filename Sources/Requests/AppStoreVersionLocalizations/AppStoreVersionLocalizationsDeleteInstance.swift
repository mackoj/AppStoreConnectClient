...
extension AppStoreConnect.AppStoreVersionLocalizations {
    ...
    public enum AppStoreVersionLocalizationsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersionLocalizations-delete_instance", tag: "AppStoreVersionLocalizations", method: "DELETE", path: "/v1/appStoreVersionLocalizations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
