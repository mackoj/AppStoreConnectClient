...
extension AppStoreConnect.GameCenterEnabledVersions {
  ...
  public enum GameCenterEnabledVersionsCompatibleVersionsDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "gameCenterEnabledVersions-compatibleVersions-delete_to_many_relationship",
      tag: "GameCenterEnabledVersions", method: "DELETE",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        ...
        super.init(
          service: GameCenterEnabledVersionsCompatibleVersionsDeleteToManyRelationship.service
        ) { defaultEncoder in
