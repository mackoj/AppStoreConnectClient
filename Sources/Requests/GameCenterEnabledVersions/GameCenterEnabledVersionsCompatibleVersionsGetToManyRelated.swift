...
extension AppStoreConnect.GameCenterEnabledVersions {
  ...
  public enum GameCenterEnabledVersionsCompatibleVersionsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "gameCenterEnabledVersions-compatibleVersions-get_to_many_related",
      tag: "GameCenterEnabledVersions", method: "GET",
      path: "/v1/gameCenterEnabledVersions/{id}/compatibleVersions", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, filterplatform: [ASCFilterplatform]? = nil,
          filterversionString: [String]? = nil, filterapp: [String]? = nil,
      ...
      public convenience init(
        id: String, filterplatform: [ASCFilterplatform]? = nil,
        filterversionString: [String]? = nil, filterapp: [String]? = nil, filterid: [String]? = nil,
        sort: [ASCSort]? = nil,
        fieldsgameCenterEnabledVersions: [ASCFieldsgameCenterEnabledVersions]? = nil,
        fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil
      ) {
        let options = Options(
          id: id, filterplatform: filterplatform, filterversionString: filterversionString,
          filterapp: filterapp, filterid: filterid, sort: sort,
          fieldsgameCenterEnabledVersions: fieldsgameCenterEnabledVersions, fieldsapps: fieldsapps,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCGameCenterEnabledVersionsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCGameCenterEnabledVersionsResponse.self, from: data))
