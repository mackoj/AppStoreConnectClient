...
extension AppStoreConnect.GameCenterEnabledVersions {
  ...
  public enum GameCenterEnabledVersionsCompatibleVersionsReplaceToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "gameCenterEnabledVersions-compatibleVersions-replace_to_many_relationship",
      tag: "GameCenterEnabledVersions", method: "PATCH",
      path: "/v1/gameCenterEnabledVersions/{id}/relationships/compatibleVersions", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCGameCenterEnabledVersionCompatibleVersionsLinkagesRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(
          service: GameCenterEnabledVersionsCompatibleVersionsReplaceToManyRelationship.service
        ) { defaultEncoder in
      ...
      public convenience init(
        id: String, body: ASCGameCenterEnabledVersionCompatibleVersionsLinkagesRequest
      ) {
