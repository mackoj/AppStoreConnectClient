...
extension AppStoreConnect.GameCenterEnabledVersions {
  ...
  public enum GameCenterEnabledVersionsCompatibleVersionsCreateToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "gameCenterEnabledVersions-compatibleVersions-create_to_many_relationship",
      tag: "GameCenterEnabledVersions", method: "POST",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        ...
        super.init(
          service: GameCenterEnabledVersionsCompatibleVersionsCreateToManyRelationship.service
        ) { defaultEncoder in
