...
extension AppStoreConnect.BetaLicenseAgreements {
  ...
  public enum BetaLicenseAgreementsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaLicenseAgreements-update_instance", tag: "BetaLicenseAgreements", method: "PATCH",
      path: "/v1/betaLicenseAgreements/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaLicenseAgreementUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaLicenseAgreementResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaLicenseAgreementResponse.self, from: data))
