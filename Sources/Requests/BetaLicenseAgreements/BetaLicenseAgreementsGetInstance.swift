...
extension AppStoreConnect.BetaLicenseAgreements {
  ...
  public enum BetaLicenseAgreementsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaLicenseAgreements-get_instance", tag: "BetaLicenseAgreements", method: "GET",
      path: "/v1/betaLicenseAgreements/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaLicenseAgreements: fieldsbetaLicenseAgreements, include: include,
