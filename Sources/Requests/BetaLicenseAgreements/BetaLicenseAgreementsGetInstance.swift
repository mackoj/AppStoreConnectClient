...
extension AppStoreConnect.BetaLicenseAgreements {
    ...
    public enum BetaLicenseAgreementsGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaLicenseAgreements-get_instance", tag: "BetaLicenseAgreements", method: "GET", path: "/v1/betaLicenseAgreements/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaLicenseAgreements: [ASCFieldsbetaLicenseAgreements]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaLicenseAgreements: [ASCFieldsbetaLicenseAgreements]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
