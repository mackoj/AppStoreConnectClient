...
extension AppStoreConnect.BetaLicenseAgreements {
    ...
    public enum BetaLicenseAgreementsGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaLicenseAgreements-get_collection", tag: "BetaLicenseAgreements", method: "GET", path: "/v1/betaLicenseAgreements", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterapp: [String]? = nil, fieldsbetaLicenseAgreements: [ASCFieldsbetaLicenseAgreements]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
            ...
            public convenience init(filterapp: [String]? = nil, fieldsbetaLicenseAgreements: [ASCFieldsbetaLicenseAgreements]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBetaLicenseAgreementsResponse

            /** List of BetaLicenseAgreements */
            case status200(ASCBetaLicenseAgreementsResponse)
            ...
            public var success: ASCBetaLicenseAgreementsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBetaLicenseAgreementsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaLicenseAgreementsResponse.self, from: data))
