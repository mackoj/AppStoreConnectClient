...
extension AppStoreConnect.BetaLicenseAgreements {
  ...
  public enum BetaLicenseAgreementsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "betaLicenseAgreements-get_collection", tag: "BetaLicenseAgreements", method: "GET",
      path: "/v1/betaLicenseAgreements", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          ...
          fieldsbetaLicenseAgreements: [ASCFieldsbetaLicenseAgreements]? = nil, limit: Int? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          filterapp: filterapp, fieldsbetaLicenseAgreements: fieldsbetaLicenseAgreements,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaLicenseAgreementsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaLicenseAgreementsResponse.self, from: data))
