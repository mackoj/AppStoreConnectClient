...
extension AppStoreConnect.BetaLicenseAgreements {
    ...
    public enum BetaLicenseAgreementsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "betaLicenseAgreements-app-get_to_one_related", tag: "BetaLicenseAgreements", method: "GET", path: "/v1/betaLicenseAgreements/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
