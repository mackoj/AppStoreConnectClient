...
extension AppStoreConnect.BetaAppReviewDetails {
  ...
  public enum BetaAppReviewDetailsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaAppReviewDetails-update_instance", tag: "BetaAppReviewDetails", method: "PATCH",
      path: "/v1/betaAppReviewDetails/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaAppReviewDetailUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaAppReviewDetailResponse.self, from: data))
