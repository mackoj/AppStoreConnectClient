...
extension AppStoreConnect.BetaAppReviewDetails {
  ...
  public enum BetaAppReviewDetailsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaAppReviewDetails-get_instance", tag: "BetaAppReviewDetails", method: "GET",
      path: "/v1/betaAppReviewDetails/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaAppReviewDetails: fieldsbetaAppReviewDetails, include: include,
