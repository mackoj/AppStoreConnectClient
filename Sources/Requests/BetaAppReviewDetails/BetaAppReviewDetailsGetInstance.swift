...
extension AppStoreConnect.BetaAppReviewDetails {
    ...
    public enum BetaAppReviewDetailsGetInstance {

        public static let service = APIService<Response>(id: "betaAppReviewDetails-get_instance", tag: "BetaAppReviewDetails", method: "GET", path: "/v1/betaAppReviewDetails/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaAppReviewDetailsGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                let options = Options(id: id, fieldsbetaAppReviewDetails: fieldsbetaAppReviewDetails, include: include, fieldsapps: fieldsapps)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBetaAppReviewDetailResponse

            /** Single BetaAppReviewDetail */
            case status200(ASCBetaAppReviewDetailResponse)
            ...
            public var success: ASCBetaAppReviewDetailResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBetaAppReviewDetailResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaAppReviewDetailResponse.self, from: data))
