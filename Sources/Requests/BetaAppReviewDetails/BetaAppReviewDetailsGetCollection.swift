...
extension AppStoreConnect.BetaAppReviewDetails {

    public enum BetaAppReviewDetailsGetCollection {

        public static let service = APIService<Response>(id: "betaAppReviewDetails-get_collection", tag: "BetaAppReviewDetails", method: "GET", path: "/v1/betaAppReviewDetails", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterapp: [String], fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaAppReviewDetailsGetCollection.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(filterapp: [String], fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                let options = Options(filterapp: filterapp, fieldsbetaAppReviewDetails: fieldsbetaAppReviewDetails, limit: limit, include: include, fieldsapps: fieldsapps)
                self.init(options: options)
            }

            public override var queryParameters: [String: Any] {
                var params: [String: Any] = [:]
                params["filter[app]"] = options.filterapp.joined(separator: ",")
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBetaAppReviewDetailsResponse

            /** List of BetaAppReviewDetails */
            case status200(ASCBetaAppReviewDetailsResponse)
            ...
            public var success: ASCBetaAppReviewDetailsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBetaAppReviewDetailsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaAppReviewDetailsResponse.self, from: data))
