...
extension AppStoreConnect.BetaAppReviewDetails {
  ...
  public enum BetaAppReviewDetailsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "betaAppReviewDetails-get_collection", tag: "BetaAppReviewDetails", method: "GET",
      path: "/v1/betaAppReviewDetails", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterapp: [String], fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil,
          limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filterapp: filterapp, fieldsbetaAppReviewDetails: fieldsbetaAppReviewDetails,
          limit: limit, include: include, fieldsapps: fieldsapps)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBetaAppReviewDetailsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaAppReviewDetailsResponse.self, from: data))
