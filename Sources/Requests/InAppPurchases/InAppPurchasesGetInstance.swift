...
extension AppStoreConnect.InAppPurchases {
    ...
    public enum InAppPurchasesGetInstance {
        ...
        public static let service = APIService<Response>(id: "inAppPurchases-get_instance", tag: "InAppPurchases", method: "GET", path: "/v1/inAppPurchases/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsinAppPurchases: [ASCFieldsinAppPurchases]? = nil, include: [ASCInclude]? = nil, limitapps: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsinAppPurchases: [ASCFieldsinAppPurchases]? = nil, include: [ASCInclude]? = nil, limitapps: Int? = nil) {
