...
extension AppStoreConnect.RoutingAppCoverages {
  ...
  public enum RoutingAppCoveragesCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "routingAppCoverages-create_instance", tag: "RoutingAppCoverages", method: "POST",
      path: "/v1/routingAppCoverages", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCRoutingAppCoverageResponse.self, from: data))
