...
extension AppStoreConnect.RoutingAppCoverages {
    ...
    public enum RoutingAppCoveragesCreateInstance {
        ...
        public static let service = APIService<Response>(id: "routingAppCoverages-create_instance", tag: "RoutingAppCoverages", method: "POST", path: "/v1/routingAppCoverages", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCRoutingAppCoverageCreateRequest

            public init(body: ASCRoutingAppCoverageCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: RoutingAppCoveragesCreateInstance.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCRoutingAppCoverageResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCRoutingAppCoverageResponse.self, from: data))
