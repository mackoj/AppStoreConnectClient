...
extension AppStoreConnect.RoutingAppCoverages {

    public enum RoutingAppCoveragesGetInstance {

        public static let service = APIService<Response>(id: "routingAppCoverages-get_instance", tag: "RoutingAppCoverages", method: "GET", path: "/v1/routingAppCoverages/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsroutingAppCoverages: [ASCFieldsroutingAppCoverages]? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: RoutingAppCoveragesGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsroutingAppCoverages: [ASCFieldsroutingAppCoverages]? = nil, include: [ASCInclude]? = nil) {
                let options = Options(id: id, fieldsroutingAppCoverages: fieldsroutingAppCoverages, include: include)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCRoutingAppCoverageResponse.self, from: data))
