...
extension AppStoreConnect.RoutingAppCoverages {
  ...
  public enum RoutingAppCoveragesGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "routingAppCoverages-get_instance", tag: "RoutingAppCoverages", method: "GET",
      path: "/v1/routingAppCoverages/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsroutingAppCoverages: fieldsroutingAppCoverages, include: include)
