...
extension AppStoreConnect.RoutingAppCoverages {
    ...
    public enum RoutingAppCoveragesDeleteInstance {

        public static let service = APIService<Response>(id: "routingAppCoverages-delete_instance", tag: "RoutingAppCoverages", method: "DELETE", path: "/v1/routingAppCoverages/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RoutingAppCoveragesDeleteInstance.service)
            }
