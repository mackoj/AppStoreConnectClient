...
extension AppStoreConnect.RoutingAppCoverages {
    ...
    public enum RoutingAppCoveragesUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "routingAppCoverages-update_instance", tag: "RoutingAppCoverages", method: "PATCH", path: "/v1/routingAppCoverages/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCRoutingAppCoverageUpdateRequest

            public init(body: ASCRoutingAppCoverageUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: RoutingAppCoveragesUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCRoutingAppCoverageUpdateRequest) {
