...
extension AppStoreConnect.RoutingAppCoverages {
  ...
  public enum RoutingAppCoveragesUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "routingAppCoverages-update_instance", tag: "RoutingAppCoverages", method: "PATCH",
      path: "/v1/routingAppCoverages/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCRoutingAppCoverageUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
