...
extension AppStoreConnect.AppEncryptionDeclarations {
    ...
    public enum AppEncryptionDeclarationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appEncryptionDeclarations-get_instance", tag: "AppEncryptionDeclarations", method: "GET", path: "/v1/appEncryptionDeclarations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappEncryptionDeclarations: [ASCFieldsappEncryptionDeclarations]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappEncryptionDeclarations: [ASCFieldsappEncryptionDeclarations]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
