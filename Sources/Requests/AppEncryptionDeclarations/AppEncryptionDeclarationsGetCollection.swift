...
extension AppStoreConnect.AppEncryptionDeclarations {
  ...
  public enum AppEncryptionDeclarationsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "appEncryptionDeclarations-get_collection", tag: "AppEncryptionDeclarations",
      method: "GET", path: "/v1/appEncryptionDeclarations", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterplatform: [ASCFilterplatform]? = nil, filterapp: [String]? = nil,
          filterbuilds: [String]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          filterplatform: filterplatform, filterapp: filterapp, filterbuilds: filterbuilds,
          fieldsappEncryptionDeclarations: fieldsappEncryptionDeclarations, limit: limit,
          include: include, fieldsapps: fieldsapps)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppEncryptionDeclarationsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppEncryptionDeclarationsResponse.self, from: data))
