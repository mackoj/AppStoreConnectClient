...
extension AppStoreConnect.AppEncryptionDeclarations {
    ...
    public enum AppEncryptionDeclarationsGetCollection {
        ...
        public static let service = APIService<Response>(id: "appEncryptionDeclarations-get_collection", tag: "AppEncryptionDeclarations", method: "GET", path: "/v1/appEncryptionDeclarations", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterplatform: [ASCFilterplatform]? = nil, filterapp: [String]? = nil, filterbuilds: [String]? = nil, fieldsappEncryptionDeclarations: [ASCFieldsappEncryptionDeclarations]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
            ...
            public convenience init(filterplatform: [ASCFilterplatform]? = nil, filterapp: [String]? = nil, filterbuilds: [String]? = nil, fieldsappEncryptionDeclarations: [ASCFieldsappEncryptionDeclarations]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppEncryptionDeclarationsResponse

            /** List of AppEncryptionDeclarations */
            case status200(ASCAppEncryptionDeclarationsResponse)
            ...
            public var success: ASCAppEncryptionDeclarationsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppEncryptionDeclarationsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppEncryptionDeclarationsResponse.self, from: data))
