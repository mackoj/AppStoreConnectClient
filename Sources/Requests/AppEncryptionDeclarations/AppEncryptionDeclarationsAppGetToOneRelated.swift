...
extension AppStoreConnect.AppEncryptionDeclarations {
    ...
    public enum AppEncryptionDeclarationsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appEncryptionDeclarations-app-get_to_one_related", tag: "AppEncryptionDeclarations", method: "GET", path: "/v1/appEncryptionDeclarations/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
