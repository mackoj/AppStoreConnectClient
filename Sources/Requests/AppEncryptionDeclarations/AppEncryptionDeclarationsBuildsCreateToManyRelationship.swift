...
extension AppStoreConnect.AppEncryptionDeclarations {
  ...
  public enum AppEncryptionDeclarationsBuildsCreateToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "appEncryptionDeclarations-builds-create_to_many_relationship",
      tag: "AppEncryptionDeclarations", method: "POST",
      path: "/v1/appEncryptionDeclarations/{id}/relationships/builds", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppEncryptionDeclarationBuildsLinkagesRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(service: AppEncryptionDeclarationsBuildsCreateToManyRelationship.service) {
          defaultEncoder in
