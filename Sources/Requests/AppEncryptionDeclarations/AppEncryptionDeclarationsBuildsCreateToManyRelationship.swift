...
extension AppStoreConnect.AppEncryptionDeclarations {
    ...
    public enum AppEncryptionDeclarationsBuildsCreateToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appEncryptionDeclarations-builds-create_to_many_relationship", tag: "AppEncryptionDeclarations", method: "POST", path: "/v1/appEncryptionDeclarations/{id}/relationships/builds", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppEncryptionDeclarationBuildsLinkagesRequest

            public init(body: ASCAppEncryptionDeclarationBuildsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppEncryptionDeclarationBuildsLinkagesRequest) {
