...
extension AppStoreConnect.EndUserLicenseAgreements {
  ...
  public enum EndUserLicenseAgreementsTerritoriesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "endUserLicenseAgreements-territories-get_to_many_related",
      tag: "EndUserLicenseAgreements", method: "GET",
      path: "/v1/endUserLicenseAgreements/{id}/territories", hasBody: false,
