...
extension AppStoreConnect.EndUserLicenseAgreements {
    ...
    public enum EndUserLicenseAgreementsGetInstance {
        ...
        public static let service = APIService<Response>(id: "endUserLicenseAgreements-get_instance", tag: "EndUserLicenseAgreements", method: "GET", path: "/v1/endUserLicenseAgreements/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsendUserLicenseAgreements: [ASCFieldsendUserLicenseAgreements]? = nil, include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil, limitterritories: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsendUserLicenseAgreements: [ASCFieldsendUserLicenseAgreements]? = nil, include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil, limitterritories: Int? = nil) {
