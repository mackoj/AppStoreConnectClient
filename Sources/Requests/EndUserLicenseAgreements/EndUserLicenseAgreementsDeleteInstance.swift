...
extension AppStoreConnect.EndUserLicenseAgreements {
    ...
    public enum EndUserLicenseAgreementsDeleteInstance {

        public static let service = APIService<Response>(id: "endUserLicenseAgreements-delete_instance", tag: "EndUserLicenseAgreements", method: "DELETE", path: "/v1/endUserLicenseAgreements/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: EndUserLicenseAgreementsDeleteInstance.service)
            }
