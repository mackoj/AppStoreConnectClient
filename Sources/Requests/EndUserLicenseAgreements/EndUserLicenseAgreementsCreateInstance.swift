...
extension AppStoreConnect.EndUserLicenseAgreements {
    ...
    public enum EndUserLicenseAgreementsCreateInstance {

        public static let service = APIService<Response>(id: "endUserLicenseAgreements-create_instance", tag: "EndUserLicenseAgreements", method: "POST", path: "/v1/endUserLicenseAgreements", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCEndUserLicenseAgreementCreateRequest

            public init(body: ASCEndUserLicenseAgreementCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: EndUserLicenseAgreementsCreateInstance.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCEndUserLicenseAgreementResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCEndUserLicenseAgreementResponse.self, from: data))
