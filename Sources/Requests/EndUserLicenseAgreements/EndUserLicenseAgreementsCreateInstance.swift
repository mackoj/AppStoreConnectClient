...
extension AppStoreConnect.EndUserLicenseAgreements {
  ...
  public enum EndUserLicenseAgreementsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "endUserLicenseAgreements-create_instance", tag: "EndUserLicenseAgreements",
      method: "POST", path: "/v1/endUserLicenseAgreements", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCEndUserLicenseAgreementResponse.self, from: data))
