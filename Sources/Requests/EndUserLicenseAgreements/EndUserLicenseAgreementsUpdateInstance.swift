...
extension AppStoreConnect.EndUserLicenseAgreements {
  ...
  public enum EndUserLicenseAgreementsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "endUserLicenseAgreements-update_instance", tag: "EndUserLicenseAgreements",
      method: "PATCH", path: "/v1/endUserLicenseAgreements/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCEndUserLicenseAgreementUpdateRequest, options: Options,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCEndUserLicenseAgreementResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCEndUserLicenseAgreementResponse.self, from: data))
