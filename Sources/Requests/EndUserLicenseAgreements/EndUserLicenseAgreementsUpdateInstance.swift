...
extension AppStoreConnect.EndUserLicenseAgreements {
    ...
    public enum EndUserLicenseAgreementsUpdateInstance {

        public static let service = APIService<Response>(id: "endUserLicenseAgreements-update_instance", tag: "EndUserLicenseAgreements", method: "PATCH", path: "/v1/endUserLicenseAgreements/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCEndUserLicenseAgreementUpdateRequest

            public init(body: ASCEndUserLicenseAgreementUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: EndUserLicenseAgreementsUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCEndUserLicenseAgreementUpdateRequest) {
