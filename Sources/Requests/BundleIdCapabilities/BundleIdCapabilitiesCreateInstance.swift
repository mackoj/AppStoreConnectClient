...
extension AppStoreConnect.BundleIdCapabilities {
  ...
  public enum BundleIdCapabilitiesCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "bundleIdCapabilities-create_instance", tag: "BundleIdCapabilities", method: "POST",
      path: "/v1/bundleIdCapabilities", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCBundleIdCapabilityResponse.self, from: data))
