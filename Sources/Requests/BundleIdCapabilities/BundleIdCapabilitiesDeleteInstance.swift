...
extension AppStoreConnect.BundleIdCapabilities {
    ...
    public enum BundleIdCapabilitiesDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIdCapabilities-delete_instance", tag: "BundleIdCapabilities", method: "DELETE", path: "/v1/bundleIdCapabilities/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BundleIdCapabilitiesDeleteInstance.service)
            }
