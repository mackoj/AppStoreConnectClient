...
extension AppStoreConnect.BundleIdCapabilities {
  ...
  public enum BundleIdCapabilitiesUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "bundleIdCapabilities-update_instance", tag: "BundleIdCapabilities", method: "PATCH",
      path: "/v1/bundleIdCapabilities/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBundleIdCapabilityUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBundleIdCapabilityResponse.self, from: data))
