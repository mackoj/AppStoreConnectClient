...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsBetaGroupsDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "builds-betaGroups-delete_to_many_relationship", tag: "Builds", method: "DELETE",
      path: "/v1/builds/{id}/relationships/betaGroups", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBuildBetaGroupsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
