...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsBetaGroupsDeleteToManyRelationship {

        public static let service = APIService<Response>(id: "builds-betaGroups-delete_to_many_relationship", tag: "Builds", method: "DELETE", path: "/v1/builds/{id}/relationships/betaGroups", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBuildBetaGroupsLinkagesRequest

            public init(body: ASCBuildBetaGroupsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BuildsBetaGroupsDeleteToManyRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBuildBetaGroupsLinkagesRequest) {
