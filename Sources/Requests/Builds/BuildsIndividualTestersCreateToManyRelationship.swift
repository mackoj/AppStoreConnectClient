...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsIndividualTestersCreateToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "builds-individualTesters-create_to_many_relationship", tag: "Builds", method: "POST",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        ...
        super.init(service: BuildsIndividualTestersCreateToManyRelationship.service) {
          defaultEncoder in
