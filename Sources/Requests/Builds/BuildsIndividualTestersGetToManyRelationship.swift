...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsIndividualTestersGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "builds-individualTesters-get_to_many_relationship", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/relationships/individualTesters", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBuildIndividualTestersLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCBuildIndividualTestersLinkagesResponse.self, from: data))
