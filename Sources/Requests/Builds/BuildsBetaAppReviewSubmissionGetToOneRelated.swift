...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsBetaAppReviewSubmissionGetToOneRelated {

        public static let service = APIService<Response>(id: "builds-betaAppReviewSubmission-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/betaAppReviewSubmission", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsBetaAppReviewSubmissionGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil) {
                let options = Options(id: id, fieldsbetaAppReviewSubmissions: fieldsbetaAppReviewSubmissions)
