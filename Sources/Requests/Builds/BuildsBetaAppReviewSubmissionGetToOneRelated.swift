...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsBetaAppReviewSubmissionGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-betaAppReviewSubmission-get_to_one_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/betaAppReviewSubmission", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaAppReviewSubmissions: fieldsbetaAppReviewSubmissions)
