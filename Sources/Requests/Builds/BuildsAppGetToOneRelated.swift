...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsAppGetToOneRelated {

        public static let service = APIService<Response>(id: "builds-app-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsAppGetToOneRelated.service)
            }
