...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsPreReleaseVersionGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-preReleaseVersion-get_to_one_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/preReleaseVersion", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCPrereleaseVersionResponse.self, from: data))
