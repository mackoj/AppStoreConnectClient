...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsPreReleaseVersionGetToOneRelated {

        public static let service = APIService<Response>(id: "builds-preReleaseVersion-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/preReleaseVersion", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldspreReleaseVersions: [ASCFieldspreReleaseVersions]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsPreReleaseVersionGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldspreReleaseVersions: [ASCFieldspreReleaseVersions]? = nil) {
                let options = Options(id: id, fieldspreReleaseVersions: fieldspreReleaseVersions)
