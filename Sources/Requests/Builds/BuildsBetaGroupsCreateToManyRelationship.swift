...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsBetaGroupsCreateToManyRelationship {

        public static let service = APIService<Response>(id: "builds-betaGroups-create_to_many_relationship", tag: "Builds", method: "POST", path: "/v1/builds/{id}/relationships/betaGroups", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ASCBuildBetaGroupsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: BuildsBetaGroupsCreateToManyRelationship.service) { defaultEncoder in
