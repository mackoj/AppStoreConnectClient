...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsAppEncryptionDeclarationGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-appEncryptionDeclaration-get_to_one_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/appEncryptionDeclaration", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappEncryptionDeclarations: [ASCFieldsappEncryptionDeclarations]? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappEncryptionDeclarations: fieldsappEncryptionDeclarations)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppEncryptionDeclarationResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppEncryptionDeclarationResponse.self, from: data))
