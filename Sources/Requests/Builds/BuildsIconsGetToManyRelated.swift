...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsIconsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-icons-get_to_many_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/icons", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsbuildIcons: [ASCFieldsbuildIcons]? = nil, limit: Int? = nil
      ) {
