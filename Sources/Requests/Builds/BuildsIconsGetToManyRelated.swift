...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsIconsGetToManyRelated {

        public static let service = APIService<Response>(id: "builds-icons-get_to_many_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/icons", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbuildIcons: [ASCFieldsbuildIcons]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsIconsGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbuildIcons: [ASCFieldsbuildIcons]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsbuildIcons: fieldsbuildIcons, limit: limit)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBuildIconsResponse

            /** List of related resources */
            case status200(ASCBuildIconsResponse)
            ...
            public var success: ASCBuildIconsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBuildIconsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBuildIconsResponse.self, from: data))
