...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsDiagnosticSignaturesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-diagnosticSignatures-get_to_many_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/diagnosticSignatures", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, filterdiagnosticType: [ASCFilterdiagnosticType]? = nil,
          fieldsdiagnosticSignatures: [ASCFieldsdiagnosticSignatures]? = nil, limit: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, filterdiagnosticType: filterdiagnosticType,
          fieldsdiagnosticSignatures: fieldsdiagnosticSignatures, limit: limit)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterdiagnosticType = options.filterdiagnosticType?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCDiagnosticSignaturesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCDiagnosticSignaturesResponse.self, from: data))
