...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsIndividualTestersGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-individualTesters-get_to_many_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/individualTesters", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsbetaTesters: [ASCFieldsbetaTesters]? = nil, limit: Int? = nil
      ) {
