...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsIndividualTestersDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "builds-individualTesters-delete_to_many_relationship", tag: "Builds", method: "DELETE",
      path: "/v1/builds/{id}/relationships/individualTesters", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBuildIndividualTestersLinkagesRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(service: BuildsIndividualTestersDeleteToManyRelationship.service) {
          defaultEncoder in
