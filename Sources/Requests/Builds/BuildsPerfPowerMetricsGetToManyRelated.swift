...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsPerfPowerMetricsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "builds-perfPowerMetrics-get_to_many_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/perfPowerMetrics", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
