...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsUpdateInstance {

        public static let service = APIService<Response>(id: "builds-update_instance", tag: "Builds", method: "PATCH", path: "/v1/builds/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBuildUpdateRequest

            public init(body: ASCBuildUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BuildsUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBuildUpdateRequest) {
