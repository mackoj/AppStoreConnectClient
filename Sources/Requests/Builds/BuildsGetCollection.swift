...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsGetCollection {
        ...
        public static let service = APIService<Response>(id: "builds-get_collection", tag: "Builds", method: "GET", path: "/v1/builds", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        /** filter by attribute 'betaAppReviewSubmission.betaReviewState' */
        public enum ASCFilterbetaAppReviewSubmissionBetaReviewState: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** filter by attribute 'betaAppReviewSubmission.betaReviewState' */
                public var filterbetaAppReviewSubmissionBetaReviewState: [ASCFilterbetaAppReviewSubmissionBetaReviewState]?
