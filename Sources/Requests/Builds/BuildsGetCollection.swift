...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "builds-get_collection", tag: "Builds", method: "GET", path: "/v1/builds", hasBody: false,
    ...
    public enum ASCFilterbetaAppReviewSubmissionBetaReviewState: String, Codable, Equatable,
      CaseIterable
    {
    ...
    public enum ASCFilterpreReleaseVersionPlatform: String, Codable, Equatable, CaseIterable {
      case ios = "IOS"
      case macOs = "MAC_OS"
      case tvOs = "TV_OS"
    }
    ...
    public enum ASCFilterprocessingState: String, Codable, Equatable, CaseIterable {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        /** filter by attribute 'betaAppReviewSubmission.betaReviewState' */
        public var filterbetaAppReviewSubmissionBetaReviewState:
          [ASCFilterbetaAppReviewSubmissionBetaReviewState]?

        /** filter by attribute 'expired' */
        public var filterexpired: [String]?

        /** filter by attribute 'preReleaseVersion.platform' */
        public var filterpreReleaseVersionPlatform: [ASCFilterpreReleaseVersionPlatform]?

        /** filter by attribute 'preReleaseVersion.version' */
        public var filterpreReleaseVersionVersion: [String]?

        /** filter by attribute 'processingState' */
        public var filterprocessingState: [ASCFilterprocessingState]?
        ...
        public init(
          filterbetaAppReviewSubmissionBetaReviewState:
            [ASCFilterbetaAppReviewSubmissionBetaReviewState]? = nil,
          filterexpired: [String]? = nil,
          filterpreReleaseVersionPlatform: [ASCFilterpreReleaseVersionPlatform]? = nil,
          filterpreReleaseVersionVersion: [String]? = nil,
          filterprocessingState: [ASCFilterprocessingState]? = nil,
          filterusesNonExemptEncryption: [String]? = nil, filterversion: [String]? = nil,
          filterapp: [String]? = nil, filterappStoreVersion: [String]? = nil,
          filterbetaGroups: [String]? = nil, filterpreReleaseVersion: [String]? = nil,
          filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil,
          ...
          self.filterbetaAppReviewSubmissionBetaReviewState =
            filterbetaAppReviewSubmissionBetaReviewState
      ...
      public convenience init(
        filterbetaAppReviewSubmissionBetaReviewState:
          [ASCFilterbetaAppReviewSubmissionBetaReviewState]? = nil, filterexpired: [String]? = nil,
        filterpreReleaseVersionPlatform: [ASCFilterpreReleaseVersionPlatform]? = nil,
        filterpreReleaseVersionVersion: [String]? = nil,
        filterprocessingState: [ASCFilterprocessingState]? = nil,
        filterusesNonExemptEncryption: [String]? = nil, filterversion: [String]? = nil,
        ...
        let options = Options(
          filterbetaAppReviewSubmissionBetaReviewState:
            filterbetaAppReviewSubmissionBetaReviewState, filterexpired: filterexpired,
          ...
          filterversion: filterversion, filterapp: filterapp,
          filterappStoreVersion: filterappStoreVersion, filterbetaGroups: filterbetaGroups,
          filterpreReleaseVersion: filterpreReleaseVersion, filterid: filterid, sort: sort,
          fieldsbuilds: fieldsbuilds, limit: limit, include: include,
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterbetaAppReviewSubmissionBetaReviewState = options
          .filterbetaAppReviewSubmissionBetaReviewState?.encode().map({ String(describing: $0) })
          .joined(separator: ",")
        {
          params["filter[betaAppReviewSubmission.betaReviewState]"] =
            filterbetaAppReviewSubmissionBetaReviewState
        }
        if let filterexpired = options.filterexpired?.joined(separator: ",") {
          params["filter[expired]"] = filterexpired
        }
        if let filterpreReleaseVersionPlatform = options.filterpreReleaseVersionPlatform?.encode()
          .map({ String(describing: $0) }).joined(separator: ",")
        {
          params["filter[preReleaseVersion.platform]"] = filterpreReleaseVersionPlatform
        }
        if let filterpreReleaseVersionVersion = options.filterpreReleaseVersionVersion?.joined(
          separator: ",")
        {
          params["filter[preReleaseVersion.version]"] = filterpreReleaseVersionVersion
        }
        if let filterprocessingState = options.filterprocessingState?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
          params["filter[processingState]"] = filterprocessingState
        }
        if let filterusesNonExemptEncryption = options.filterusesNonExemptEncryption?.joined(
          separator: ",")
        {
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      public typealias SuccessType = ASCBuildsResponse

      /** List of Builds */
      case status200(ASCBuildsResponse)
      ...
      public var success: ASCBuildsResponse? {
        switch self {
      ...
      public var responseResult: APIResponseResult<ASCBuildsResponse, ASCErrorResponse> {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(ASCBuildsResponse.self, from: data))
