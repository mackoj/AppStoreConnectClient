...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsBuildBetaDetailGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-buildBetaDetail-get_to_one_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/buildBetaDetail", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil
      ) {
