...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsBuildBetaDetailGetToOneRelated {

        public static let service = APIService<Response>(id: "builds-buildBetaDetail-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/buildBetaDetail", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsBuildBetaDetailGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil) {
                let options = Options(id: id, fieldsbuildBetaDetails: fieldsbuildBetaDetails)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBuildBetaDetailResponse

            /** Related resource */
            case status200(ASCBuildBetaDetailResponse)
            ...
            public var success: ASCBuildBetaDetailResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBuildBetaDetailResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBuildBetaDetailResponse.self, from: data))
