...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsAppEncryptionDeclarationUpdateToOneRelationship {
    ...
    public static let service = APIService<Response>(
      id: "builds-appEncryptionDeclaration-update_to_one_relationship", tag: "Builds",
      method: "PATCH", path: "/v1/builds/{id}/relationships/appEncryptionDeclaration",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBuildAppEncryptionDeclarationLinkageRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(service: BuildsAppEncryptionDeclarationUpdateToOneRelationship.service) {
          defaultEncoder in
