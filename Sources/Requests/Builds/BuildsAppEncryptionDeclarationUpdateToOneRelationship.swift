...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsAppEncryptionDeclarationUpdateToOneRelationship {

        public static let service = APIService<Response>(id: "builds-appEncryptionDeclaration-update_to_one_relationship", tag: "Builds", method: "PATCH", path: "/v1/builds/{id}/relationships/appEncryptionDeclaration", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBuildAppEncryptionDeclarationLinkageRequest

            public init(body: ASCBuildAppEncryptionDeclarationLinkageRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BuildsAppEncryptionDeclarationUpdateToOneRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBuildAppEncryptionDeclarationLinkageRequest) {
