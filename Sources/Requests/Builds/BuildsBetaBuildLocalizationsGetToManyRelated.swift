...
extension AppStoreConnect.Builds {
  ...
  public enum BuildsBetaBuildLocalizationsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "builds-betaBuildLocalizations-get_to_many_related", tag: "Builds", method: "GET",
      path: "/v1/builds/{id}/betaBuildLocalizations", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaBuildLocalizations: fieldsbetaBuildLocalizations, limit: limit)
