...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsBetaBuildLocalizationsGetToManyRelated {

        public static let service = APIService<Response>(id: "builds-betaBuildLocalizations-get_to_many_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/betaBuildLocalizations", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaBuildLocalizations: [ASCFieldsbetaBuildLocalizations]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsBetaBuildLocalizationsGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaBuildLocalizations: [ASCFieldsbetaBuildLocalizations]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsbetaBuildLocalizations: fieldsbetaBuildLocalizations, limit: limit)
