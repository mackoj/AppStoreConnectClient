...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsAppStoreVersionGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "builds-appStoreVersion-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/appStoreVersion", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappStoreVersions: [ASCFieldsappStoreVersions]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappStoreVersions: [ASCFieldsappStoreVersions]? = nil) {
