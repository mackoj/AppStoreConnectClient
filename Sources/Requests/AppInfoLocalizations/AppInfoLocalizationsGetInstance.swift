...
extension AppStoreConnect.AppInfoLocalizations {
  ...
  public enum AppInfoLocalizationsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appInfoLocalizations-get_instance", tag: "AppInfoLocalizations", method: "GET",
      path: "/v1/appInfoLocalizations/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappInfoLocalizations: fieldsappInfoLocalizations, include: include)
