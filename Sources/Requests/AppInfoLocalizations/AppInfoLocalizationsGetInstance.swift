...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-get_instance", tag: "AppInfoLocalizations", method: "GET", path: "/v1/appInfoLocalizations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, include: [ASCInclude]? = nil) {
