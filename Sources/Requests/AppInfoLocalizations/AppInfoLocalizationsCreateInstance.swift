...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-create_instance", tag: "AppInfoLocalizations", method: "POST", path: "/v1/appInfoLocalizations", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppInfoLocalizationCreateRequest

            public init(body: ASCAppInfoLocalizationCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppInfoLocalizationResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppInfoLocalizationResponse.self, from: data))
