...
extension AppStoreConnect.AppInfoLocalizations {
  ...
  public enum AppInfoLocalizationsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appInfoLocalizations-create_instance", tag: "AppInfoLocalizations", method: "POST",
      path: "/v1/appInfoLocalizations", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCAppInfoLocalizationResponse.self, from: data))
