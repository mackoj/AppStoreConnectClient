...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-update_instance", tag: "AppInfoLocalizations", method: "PATCH", path: "/v1/appInfoLocalizations/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppInfoLocalizationUpdateRequest

            public init(body: ASCAppInfoLocalizationUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppInfoLocalizationUpdateRequest) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppInfoLocalizationResponse

            /** Single AppInfoLocalization */
            case status200(ASCAppInfoLocalizationResponse)
            ...
            public var success: ASCAppInfoLocalizationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppInfoLocalizationResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppInfoLocalizationResponse.self, from: data))
