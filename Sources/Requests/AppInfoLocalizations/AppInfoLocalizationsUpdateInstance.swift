...
extension AppStoreConnect.AppInfoLocalizations {
  ...
  public enum AppInfoLocalizationsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appInfoLocalizations-update_instance", tag: "AppInfoLocalizations", method: "PATCH",
      path: "/v1/appInfoLocalizations/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppInfoLocalizationUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCAppInfoLocalizationResponse.self, from: data))
