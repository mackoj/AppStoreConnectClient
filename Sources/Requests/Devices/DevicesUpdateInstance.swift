...
extension AppStoreConnect.Devices {
    ...
    public enum DevicesUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "devices-update_instance", tag: "Devices", method: "PATCH", path: "/v1/devices/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCDeviceUpdateRequest

            public init(body: ASCDeviceUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: DevicesUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCDeviceUpdateRequest) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCDeviceResponse

            /** Single Device */
            case status200(ASCDeviceResponse)
            ...
            public var success: ASCDeviceResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCDeviceResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCDeviceResponse.self, from: data))
