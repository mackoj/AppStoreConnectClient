...
extension AppStoreConnect.Devices {
    ...
    public enum DevicesGetInstance {
        ...
        public static let service = APIService<Response>(id: "devices-get_instance", tag: "Devices", method: "GET", path: "/v1/devices/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsdevices: [ASCFieldsdevices]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: DevicesGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsdevices: [ASCFieldsdevices]? = nil) {
                let options = Options(id: id, fieldsdevices: fieldsdevices)
