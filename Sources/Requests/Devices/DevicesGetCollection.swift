...
extension AppStoreConnect.Devices {
    ...
    public enum DevicesGetCollection {
        ...
        public static let service = APIService<Response>(id: "devices-get_collection", tag: "Devices", method: "GET", path: "/v1/devices", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public enum ASCFilterstatus: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** filter by attribute 'status' */
                public var filterstatus: [ASCFilterstatus]?
                ...
                public init(filtername: [String]? = nil, filterplatform: [ASCFilterplatform]? = nil, filterstatus: [ASCFilterstatus]? = nil, filterudid: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsdevices: [ASCFieldsdevices]? = nil, limit: Int? = nil) {
            ...
            public convenience init(filtername: [String]? = nil, filterplatform: [ASCFilterplatform]? = nil, filterstatus: [ASCFilterstatus]? = nil, filterudid: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsdevices: [ASCFieldsdevices]? = nil, limit: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCDevicesResponse

            /** List of Devices */
            case status200(ASCDevicesResponse)
            ...
            public var success: ASCDevicesResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCDevicesResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCDevicesResponse.self, from: data))
