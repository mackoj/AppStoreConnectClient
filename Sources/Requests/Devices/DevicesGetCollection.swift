...
extension AppStoreConnect.Devices {
  ...
  public enum DevicesGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "devices-get_collection", tag: "Devices", method: "GET", path: "/v1/devices",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filtername: [String]? = nil, filterplatform: [ASCFilterplatform]? = nil,
          filterstatus: [ASCFilterstatus]? = nil, filterudid: [String]? = nil,
          filterid: [String]? = nil, sort: [ASCSort]? = nil,
          fieldsdevices: [ASCFieldsdevices]? = nil, limit: Int? = nil
        ) {
      ...
      public convenience init(
        filtername: [String]? = nil, filterplatform: [ASCFilterplatform]? = nil,
        filterstatus: [ASCFilterstatus]? = nil, filterudid: [String]? = nil,
        filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsdevices: [ASCFieldsdevices]? = nil,
        limit: Int? = nil
      ) {
        let options = Options(
          filtername: filtername, filterplatform: filterplatform, filterstatus: filterstatus,
          filterudid: filterudid, filterid: filterid, sort: sort, fieldsdevices: fieldsdevices,
          limit: limit)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterstatus = options.filterstatus?.encode().map({ String(describing: $0) }).joined(
          separator: ",")
        {
