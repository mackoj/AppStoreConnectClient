...
extension AppStoreConnect.BetaAppReviewSubmissions {
    ...
    public enum BetaAppReviewSubmissionsGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewSubmissions-get_collection", tag: "BetaAppReviewSubmissions", method: "GET", path: "/v1/betaAppReviewSubmissions", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterbetaReviewState: [ASCFilterbetaReviewState]? = nil, filterbuild: [String], fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
            ...
            public convenience init(filterbetaReviewState: [ASCFilterbetaReviewState]? = nil, filterbuild: [String], fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<ASCBetaAppReviewSubmissionsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaAppReviewSubmissionsResponse.self, from: data))
