...
extension AppStoreConnect.BetaAppReviewSubmissions {
  ...
  public enum BetaAppReviewSubmissionsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaAppReviewSubmissions-get_instance", tag: "BetaAppReviewSubmissions", method: "GET",
      path: "/v1/betaAppReviewSubmissions/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaAppReviewSubmissions: fieldsbetaAppReviewSubmissions, include: include,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaAppReviewSubmissionResponse.self, from: data))
