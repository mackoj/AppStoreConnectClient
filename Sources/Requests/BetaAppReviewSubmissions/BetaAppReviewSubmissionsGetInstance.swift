...
extension AppStoreConnect.BetaAppReviewSubmissions {
    ...
    public enum BetaAppReviewSubmissionsGetInstance {

        public static let service = APIService<Response>(id: "betaAppReviewSubmissions-get_instance", tag: "BetaAppReviewSubmissions", method: "GET", path: "/v1/betaAppReviewSubmissions/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaAppReviewSubmissionsGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaAppReviewSubmissions: [ASCFieldsbetaAppReviewSubmissions]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
                let options = Options(id: id, fieldsbetaAppReviewSubmissions: fieldsbetaAppReviewSubmissions, include: include, fieldsbuilds: fieldsbuilds)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status200(ASCBetaAppReviewSubmissionResponse)
            ...
            public var responseResult: APIResponseResult<ASCBetaAppReviewSubmissionResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaAppReviewSubmissionResponse.self, from: data))
