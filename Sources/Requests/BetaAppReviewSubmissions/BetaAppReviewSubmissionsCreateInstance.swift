...
extension AppStoreConnect.BetaAppReviewSubmissions {
    ...
    public enum BetaAppReviewSubmissionsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewSubmissions-create_instance", tag: "BetaAppReviewSubmissions", method: "POST", path: "/v1/betaAppReviewSubmissions", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCBetaAppReviewSubmissionResponse.self, from: data))
