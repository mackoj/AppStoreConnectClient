...
extension AppStoreConnect.BetaAppReviewSubmissions {
    ...
    public enum BetaAppReviewSubmissionsBuildGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewSubmissions-build-get_to_one_related", tag: "BetaAppReviewSubmissions", method: "GET", path: "/v1/betaAppReviewSubmissions/{id}/build", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
