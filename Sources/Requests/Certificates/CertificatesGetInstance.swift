...
extension AppStoreConnect.Certificates {
    ...
    public enum CertificatesGetInstance {
        ...
        public static let service = APIService<Response>(id: "certificates-get_instance", tag: "Certificates", method: "GET", path: "/v1/certificates/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldscertificates: [ASCFieldscertificates]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: CertificatesGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldscertificates: [ASCFieldscertificates]? = nil) {
                let options = Options(id: id, fieldscertificates: fieldscertificates)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCCertificateResponse

            /** Single Certificate */
            case status200(ASCCertificateResponse)
            ...
            public var success: ASCCertificateResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCCertificateResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCCertificateResponse.self, from: data))
