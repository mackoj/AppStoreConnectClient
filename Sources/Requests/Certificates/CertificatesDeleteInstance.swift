...
extension AppStoreConnect.Certificates {
    ...
    public enum CertificatesDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "certificates-delete_instance", tag: "Certificates", method: "DELETE", path: "/v1/certificates/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CertificatesDeleteInstance.service)
            }
