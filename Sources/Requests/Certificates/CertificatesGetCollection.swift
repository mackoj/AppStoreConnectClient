...
extension AppStoreConnect.Certificates {
  ...
  public enum CertificatesGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "certificates-get_collection", tag: "Certificates", method: "GET",
      path: "/v1/certificates", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filtercertificateType: [ASCFiltercertificateType]? = nil,
          filterdisplayName: [String]? = nil, filterserialNumber: [String]? = nil,
          filterid: [String]? = nil, sort: [ASCSort]? = nil,
          fieldscertificates: [ASCFieldscertificates]? = nil, limit: Int? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filtercertificateType: filtercertificateType, filterdisplayName: filterdisplayName,
          filterserialNumber: filterserialNumber, filterid: filterid, sort: sort,
          fieldscertificates: fieldscertificates, limit: limit)
        self.init(options: options)
      }

      public override var queryParameters: [String: Any] {
        var params: [String: Any] = [:]
        if let filtercertificateType = options.filtercertificateType?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
