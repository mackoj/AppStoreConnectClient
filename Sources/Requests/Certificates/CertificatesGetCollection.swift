...
extension AppStoreConnect.Certificates {
    ...
    public enum CertificatesGetCollection {
        ...
        public static let service = APIService<Response>(id: "certificates-get_collection", tag: "Certificates", method: "GET", path: "/v1/certificates", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        /** filter by attribute 'certificateType' */
        public enum ASCFiltercertificateType: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** filter by attribute 'certificateType' */
                public var filtercertificateType: [ASCFiltercertificateType]?
                ...
                public init(filtercertificateType: [ASCFiltercertificateType]? = nil, filterdisplayName: [String]? = nil, filterserialNumber: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldscertificates: [ASCFieldscertificates]? = nil, limit: Int? = nil) {
            ...
            public convenience init(filtercertificateType: [ASCFiltercertificateType]? = nil, filterdisplayName: [String]? = nil, filterserialNumber: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldscertificates: [ASCFieldscertificates]? = nil, limit: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCCertificatesResponse

            /** List of Certificates */
            case status200(ASCCertificatesResponse)
            ...
            public var success: ASCCertificatesResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCCertificatesResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCCertificatesResponse.self, from: data))
