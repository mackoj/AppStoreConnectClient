...
extension AppStoreConnect.AppCategories {
  ...
  public enum AppCategoriesSubcategoriesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "appCategories-subcategories-get_to_many_related", tag: "AppCategories", method: "GET",
      path: "/v1/appCategories/{id}/subcategories", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappCategories: [ASCFieldsappCategories]? = nil, limit: Int? = nil
        ) {
          self.id = id
