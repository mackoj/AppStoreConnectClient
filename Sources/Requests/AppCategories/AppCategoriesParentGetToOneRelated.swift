...
extension AppStoreConnect.AppCategories {
    ...
    public enum AppCategoriesParentGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appCategories-parent-get_to_one_related", tag: "AppCategories", method: "GET", path: "/v1/appCategories/{id}/parent", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
