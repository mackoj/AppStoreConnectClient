...
extension AppStoreConnect.AppCategories {
    ...
    public enum AppCategoriesGetCollection {
        ...
        public static let service = APIService<Response>(id: "appCategories-get_collection", tag: "AppCategories", method: "GET", path: "/v1/appCategories", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterplatforms: [ASCFilterplatforms]? = nil, existsparent: [String]? = nil, fieldsappCategories: [ASCFieldsappCategories]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, limitsubcategories: Int? = nil) {
            ...
            public convenience init(filterplatforms: [ASCFilterplatforms]? = nil, existsparent: [String]? = nil, fieldsappCategories: [ASCFieldsappCategories]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, limitsubcategories: Int? = nil) {
