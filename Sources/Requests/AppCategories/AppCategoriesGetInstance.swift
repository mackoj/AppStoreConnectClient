...
extension AppStoreConnect.AppCategories {
    ...
    public enum AppCategoriesGetInstance {
        ...
        public static let service = APIService<Response>(id: "appCategories-get_instance", tag: "AppCategories", method: "GET", path: "/v1/appCategories/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappCategories: [ASCFieldsappCategories]? = nil, include: [ASCInclude]? = nil, limitsubcategories: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappCategories: [ASCFieldsappCategories]? = nil, include: [ASCInclude]? = nil, limitsubcategories: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppCategoryResponse

            /** Single AppCategory */
            case status200(ASCAppCategoryResponse)
            ...
            public var success: ASCAppCategoryResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppCategoryResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppCategoryResponse.self, from: data))
