...
extension AppStoreConnect.AppCategories {
  ...
  public enum AppCategoriesGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appCategories-get_instance", tag: "AppCategories", method: "GET",
      path: "/v1/appCategories/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappCategories: [ASCFieldsappCategories]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappCategories: fieldsappCategories, include: include,
