...
extension AppStoreConnect.AppPreviews {
    ...
    public enum AppPreviewsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviews-delete_instance", tag: "AppPreviews", method: "DELETE", path: "/v1/appPreviews/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
