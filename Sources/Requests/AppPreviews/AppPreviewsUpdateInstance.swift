...
extension AppStoreConnect.AppPreviews {
    ...
    public enum AppPreviewsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviews-update_instance", tag: "AppPreviews", method: "PATCH", path: "/v1/appPreviews/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppPreviewUpdateRequest

            public init(body: ASCAppPreviewUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppPreviewUpdateRequest) {
