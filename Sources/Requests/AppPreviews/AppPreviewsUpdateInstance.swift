...
extension AppStoreConnect.AppPreviews {
  ...
  public enum AppPreviewsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPreviews-update_instance", tag: "AppPreviews", method: "PATCH",
      path: "/v1/appPreviews/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppPreviewUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
