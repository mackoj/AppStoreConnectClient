...
extension AppStoreConnect.AppPreviews {
  ...
  public enum AppPreviewsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPreviews-get_instance", tag: "AppPreviews", method: "GET",
      path: "/v1/appPreviews/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, include: [ASCInclude]? = nil
        ) {
          self.id = id
