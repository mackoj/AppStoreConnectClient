...
extension AppStoreConnect.AppPreviews {
    ...
    public enum AppPreviewsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviews-create_instance", tag: "AppPreviews", method: "POST", path: "/v1/appPreviews", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppPreviewCreateRequest

            public init(body: ASCAppPreviewCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single AppPreview */
            case status201(ASCAppPreviewResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppPreviewResponse.self, from: data))
