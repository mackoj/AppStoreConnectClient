...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsAppStoreReviewDetailGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-appStoreReviewDetail-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/appStoreReviewDetail", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappStoreReviewDetails: [ASCFieldsappStoreReviewDetails]? = nil, fieldsappStoreVersions: [ASCFieldsappStoreVersions]? = nil, fieldsappStoreReviewAttachments: [ASCFieldsappStoreReviewAttachments]? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappStoreReviewDetails: [ASCFieldsappStoreReviewDetails]? = nil, fieldsappStoreVersions: [ASCFieldsappStoreVersions]? = nil, fieldsappStoreReviewAttachments: [ASCFieldsappStoreReviewAttachments]? = nil, include: [ASCInclude]? = nil) {
