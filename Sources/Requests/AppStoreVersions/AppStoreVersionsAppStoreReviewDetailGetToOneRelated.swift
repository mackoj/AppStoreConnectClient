...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsAppStoreReviewDetailGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-appStoreReviewDetail-get_to_one_related", tag: "AppStoreVersions",
      method: "GET", path: "/v1/appStoreVersions/{id}/appStoreReviewDetail", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          ...
          fieldsappStoreReviewAttachments: fieldsappStoreReviewAttachments, include: include)
