...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsBuildUpdateToOneRelationship {

        public static let service = APIService<Response>(id: "appStoreVersions-build-update_to_one_relationship", tag: "AppStoreVersions", method: "PATCH", path: "/v1/appStoreVersions/{id}/relationships/build", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppStoreVersionBuildLinkageRequest

            public init(body: ASCAppStoreVersionBuildLinkageRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: AppStoreVersionsBuildUpdateToOneRelationship.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCAppStoreVersionBuildLinkageRequest) {
