...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsBuildGetToOneRelationship {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-build-get_to_one_relationship", tag: "AppStoreVersions", method: "GET",
      path: "/v1/appStoreVersions/{id}/relationships/build", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppStoreVersionBuildLinkageResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppStoreVersionBuildLinkageResponse.self, from: data))
