...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsRoutingAppCoverageGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-routingAppCoverage-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/routingAppCoverage", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(id: String, fieldsroutingAppCoverages: [ASCFieldsroutingAppCoverages]? = nil) {
