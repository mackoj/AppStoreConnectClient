...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-create_instance", tag: "AppStoreVersions", method: "POST", path: "/v1/appStoreVersions", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppStoreVersionCreateRequest

            public init(body: ASCAppStoreVersionCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppStoreVersionResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppStoreVersionResponse.self, from: data))
