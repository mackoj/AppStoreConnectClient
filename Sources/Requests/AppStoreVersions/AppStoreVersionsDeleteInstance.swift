...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsDeleteInstance {

        public static let service = APIService<Response>(id: "appStoreVersions-delete_instance", tag: "AppStoreVersions", method: "DELETE", path: "/v1/appStoreVersions/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionsDeleteInstance.service)
            }
