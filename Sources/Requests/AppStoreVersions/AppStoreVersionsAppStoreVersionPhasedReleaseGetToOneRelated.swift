...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsAppStoreVersionPhasedReleaseGetToOneRelated {

        public static let service = APIService<Response>(id: "appStoreVersions-appStoreVersionPhasedRelease-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/appStoreVersionPhasedRelease", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappStoreVersionPhasedReleases: [ASCFieldsappStoreVersionPhasedReleases]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionsAppStoreVersionPhasedReleaseGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsappStoreVersionPhasedReleases: [ASCFieldsappStoreVersionPhasedReleases]? = nil) {
                let options = Options(id: id, fieldsappStoreVersionPhasedReleases: fieldsappStoreVersionPhasedReleases)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppStoreVersionPhasedReleaseResponse

            /** Related resource */
            case status200(ASCAppStoreVersionPhasedReleaseResponse)
            ...
            public var success: ASCAppStoreVersionPhasedReleaseResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppStoreVersionPhasedReleaseResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppStoreVersionPhasedReleaseResponse.self, from: data))
