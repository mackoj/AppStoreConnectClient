...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsAppStoreVersionPhasedReleaseGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-appStoreVersionPhasedRelease-get_to_one_related",
      tag: "AppStoreVersions", method: "GET",
      path: "/v1/appStoreVersions/{id}/appStoreVersionPhasedRelease", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappStoreVersionPhasedReleases: fieldsappStoreVersionPhasedReleases)
