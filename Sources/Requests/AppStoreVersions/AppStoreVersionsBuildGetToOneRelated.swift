...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsBuildGetToOneRelated {

        public static let service = APIService<Response>(id: "appStoreVersions-build-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/build", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionsBuildGetToOneRelated.service)
            }
