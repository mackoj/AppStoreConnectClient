...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsAppStoreVersionSubmissionGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-appStoreVersionSubmission-get_to_one_related", tag: "AppStoreVersions",
      method: "GET", path: "/v1/appStoreVersions/{id}/appStoreVersionSubmission", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappStoreVersions: fieldsappStoreVersions,
          fieldsappStoreVersionSubmissions: fieldsappStoreVersionSubmissions, include: include)
