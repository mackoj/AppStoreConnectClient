...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsAgeRatingDeclarationGetToOneRelated {

        public static let service = APIService<Response>(id: "appStoreVersions-ageRatingDeclaration-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/ageRatingDeclaration", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsageRatingDeclarations: [ASCFieldsageRatingDeclarations]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionsAgeRatingDeclarationGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsageRatingDeclarations: [ASCFieldsageRatingDeclarations]? = nil) {
                let options = Options(id: id, fieldsageRatingDeclarations: fieldsageRatingDeclarations)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAgeRatingDeclarationResponse

            /** Related resource */
            case status200(ASCAgeRatingDeclarationResponse)
            ...
            public var success: ASCAgeRatingDeclarationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAgeRatingDeclarationResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAgeRatingDeclarationResponse.self, from: data))
