...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsAgeRatingDeclarationGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-ageRatingDeclaration-get_to_one_related", tag: "AppStoreVersions",
      method: "GET", path: "/v1/appStoreVersions/{id}/ageRatingDeclaration", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsageRatingDeclarations: [ASCFieldsageRatingDeclarations]? = nil
        ) {
          self.id = id
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAgeRatingDeclarationResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCAgeRatingDeclarationResponse.self, from: data))
