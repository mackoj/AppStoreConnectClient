...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-update_instance", tag: "AppStoreVersions", method: "PATCH", path: "/v1/appStoreVersions/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppStoreVersionUpdateRequest

            public init(body: ASCAppStoreVersionUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppStoreVersionUpdateRequest) {
