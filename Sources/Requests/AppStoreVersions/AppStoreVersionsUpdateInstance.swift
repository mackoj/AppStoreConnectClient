...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-update_instance", tag: "AppStoreVersions", method: "PATCH",
      path: "/v1/appStoreVersions/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppStoreVersionUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
