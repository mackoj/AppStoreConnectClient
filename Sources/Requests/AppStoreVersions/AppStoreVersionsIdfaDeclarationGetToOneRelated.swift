...
extension AppStoreConnect.AppStoreVersions {
  ...
  public enum AppStoreVersionsIdfaDeclarationGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "appStoreVersions-idfaDeclaration-get_to_one_related", tag: "AppStoreVersions",
      method: "GET", path: "/v1/appStoreVersions/{id}/idfaDeclaration", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsidfaDeclarations: [ASCFieldsidfaDeclarations]? = nil
      ) {
