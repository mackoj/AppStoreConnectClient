...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsIdfaDeclarationGetToOneRelated {

        public static let service = APIService<Response>(id: "appStoreVersions-idfaDeclaration-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/idfaDeclaration", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsidfaDeclarations: [ASCFieldsidfaDeclarations]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: AppStoreVersionsIdfaDeclarationGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsidfaDeclarations: [ASCFieldsidfaDeclarations]? = nil) {
                let options = Options(id: id, fieldsidfaDeclarations: fieldsidfaDeclarations)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCIdfaDeclarationResponse

            /** Related resource */
            case status200(ASCIdfaDeclarationResponse)
            ...
            public var success: ASCIdfaDeclarationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCIdfaDeclarationResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCIdfaDeclarationResponse.self, from: data))
