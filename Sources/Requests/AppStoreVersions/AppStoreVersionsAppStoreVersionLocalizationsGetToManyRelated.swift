...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsAppStoreVersionLocalizationsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-appStoreVersionLocalizations-get_to_many_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/appStoreVersionLocalizations", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsappStoreVersionLocalizations: fieldsappStoreVersionLocalizations, limit: limit)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<ASCAppStoreVersionLocalizationsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppStoreVersionLocalizationsResponse.self, from: data))
