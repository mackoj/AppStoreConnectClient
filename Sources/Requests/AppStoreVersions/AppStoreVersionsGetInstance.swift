...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-get_instance", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappStoreVersions: [ASCFieldsappStoreVersions]? = nil, include: [ASCInclude]? = nil, fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil, fieldsidfaDeclarations: [ASCFieldsidfaDeclarations]? = nil, fieldsroutingAppCoverages: [ASCFieldsroutingAppCoverages]? = nil, fieldsappStoreVersionPhasedReleases: [ASCFieldsappStoreVersionPhasedReleases]? = nil, fieldsageRatingDeclarations: [ASCFieldsageRatingDeclarations]? = nil, fieldsappStoreReviewDetails: [ASCFieldsappStoreReviewDetails]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsappStoreVersionSubmissions: [ASCFieldsappStoreVersionSubmissions]? = nil, limitappStoreVersionLocalizations: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappStoreVersions: [ASCFieldsappStoreVersions]? = nil, include: [ASCInclude]? = nil, fieldsappStoreVersionLocalizations: [ASCFieldsappStoreVersionLocalizations]? = nil, fieldsidfaDeclarations: [ASCFieldsidfaDeclarations]? = nil, fieldsroutingAppCoverages: [ASCFieldsroutingAppCoverages]? = nil, fieldsappStoreVersionPhasedReleases: [ASCFieldsappStoreVersionPhasedReleases]? = nil, fieldsageRatingDeclarations: [ASCFieldsageRatingDeclarations]? = nil, fieldsappStoreReviewDetails: [ASCFieldsappStoreReviewDetails]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsappStoreVersionSubmissions: [ASCFieldsappStoreVersionSubmissions]? = nil, limitappStoreVersionLocalizations: Int? = nil) {
