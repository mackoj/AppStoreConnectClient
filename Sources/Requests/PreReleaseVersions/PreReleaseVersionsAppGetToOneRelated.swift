...
extension AppStoreConnect.PreReleaseVersions {
    ...
    public enum PreReleaseVersionsAppGetToOneRelated {

        public static let service = APIService<Response>(id: "preReleaseVersions-app-get_to_one_related", tag: "PreReleaseVersions", method: "GET", path: "/v1/preReleaseVersions/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PreReleaseVersionsAppGetToOneRelated.service)
            }
