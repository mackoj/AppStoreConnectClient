...
extension AppStoreConnect.PreReleaseVersions {
  ...
  public enum PreReleaseVersionsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "preReleaseVersions-get_instance", tag: "PreReleaseVersions", method: "GET",
      path: "/v1/preReleaseVersions/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldspreReleaseVersions: fieldspreReleaseVersions, include: include,
          fieldsbuilds: fieldsbuilds, fieldsapps: fieldsapps, limitbuilds: limitbuilds)
