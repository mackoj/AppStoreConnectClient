...
extension AppStoreConnect.PreReleaseVersions {
  ...
  public enum PreReleaseVersionsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "preReleaseVersions-get_collection", tag: "PreReleaseVersions", method: "GET",
      path: "/v1/preReleaseVersions", hasBody: false,
      securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

    /** filter by attribute 'builds.processingState' */
    public enum ASCFilterbuildsProcessingState: String, Codable, Equatable, CaseIterable {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        /** filter by attribute 'builds.processingState' */
        public var filterbuildsProcessingState: [ASCFilterbuildsProcessingState]?
        ...
        public init(
          filterbuildsExpired: [String]? = nil,
          filterbuildsProcessingState: [ASCFilterbuildsProcessingState]? = nil,
          filterplatform: [ASCFilterplatform]? = nil, filterversion: [String]? = nil,
          filterapp: [String]? = nil, filterbuilds: [String]? = nil, sort: [ASCSort]? = nil,
          fieldspreReleaseVersions: [ASCFieldspreReleaseVersions]? = nil, limit: Int? = nil,
          include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil,
          fieldsapps: [ASCFieldsapps]? = nil, limitbuilds: Int? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          ...
          filterbuildsProcessingState: filterbuildsProcessingState, filterplatform: filterplatform,
          filterversion: filterversion, filterapp: filterapp, filterbuilds: filterbuilds,
          sort: sort, fieldspreReleaseVersions: fieldspreReleaseVersions, limit: limit,
          include: include, fieldsbuilds: fieldsbuilds, fieldsapps: fieldsapps,
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterbuildsProcessingState = options.filterbuildsProcessingState?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      public typealias SuccessType = ASCPreReleaseVersionsResponse

      /** List of PreReleaseVersions */
      case status200(ASCPreReleaseVersionsResponse)
      ...
      public var success: ASCPreReleaseVersionsResponse? {
        switch self {
      ...
      public var responseResult: APIResponseResult<ASCPreReleaseVersionsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCPreReleaseVersionsResponse.self, from: data))
