...
extension AppStoreConnect.PreReleaseVersions {
    ...
    public enum PreReleaseVersionsGetCollection {
        ...
        public static let service = APIService<Response>(id: "preReleaseVersions-get_collection", tag: "PreReleaseVersions", method: "GET", path: "/v1/preReleaseVersions", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterbuildsExpired: [String]? = nil, filterbuildsProcessingState: [ASCFilterbuildsProcessingState]? = nil, filterplatform: [ASCFilterplatform]? = nil, filterversion: [String]? = nil, filterapp: [String]? = nil, filterbuilds: [String]? = nil, sort: [ASCSort]? = nil, fieldspreReleaseVersions: [ASCFieldspreReleaseVersions]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitbuilds: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCPreReleaseVersionsResponse.self, from: data))
