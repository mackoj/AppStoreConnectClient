...
extension AppStoreConnect.UserInvitations {
    ...
    public enum UserInvitationsVisibleAppsGetToManyRelated {

        public static let service = APIService<Response>(id: "userInvitations-visibleApps-get_to_many_related", tag: "UserInvitations", method: "GET", path: "/v1/userInvitations/{id}/visibleApps", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: UserInvitationsVisibleAppsGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsapps: fieldsapps, limit: limit)
