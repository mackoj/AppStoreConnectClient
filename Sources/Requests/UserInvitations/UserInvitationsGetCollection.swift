...
extension AppStoreConnect.UserInvitations {
  ...
  public enum UserInvitationsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "userInvitations-get_collection", tag: "UserInvitations", method: "GET",
      path: "/v1/userInvitations", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filteremail: [String]? = nil, filterroles: [ASCFilterroles]? = nil,
          filtervisibleApps: [String]? = nil, sort: [ASCSort]? = nil,
          fieldsuserInvitations: [ASCFieldsuserInvitations]? = nil, limit: Int? = nil,
          include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil,
          limitvisibleApps: Int? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filteremail: filteremail, filterroles: filterroles, filtervisibleApps: filtervisibleApps,
          sort: sort, fieldsuserInvitations: fieldsuserInvitations, limit: limit, include: include,
          fieldsapps: fieldsapps, limitvisibleApps: limitvisibleApps)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterroles = options.filterroles?.encode().map({ String(describing: $0) }).joined(
          separator: ",")
        {
        ...
        if let fieldsuserInvitations = options.fieldsuserInvitations?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
