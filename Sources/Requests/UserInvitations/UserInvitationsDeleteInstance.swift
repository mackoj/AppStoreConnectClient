...
extension AppStoreConnect.UserInvitations {
    ...
    public enum UserInvitationsDeleteInstance {

        public static let service = APIService<Response>(id: "userInvitations-delete_instance", tag: "UserInvitations", method: "DELETE", path: "/v1/userInvitations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserInvitationsDeleteInstance.service)
            }
