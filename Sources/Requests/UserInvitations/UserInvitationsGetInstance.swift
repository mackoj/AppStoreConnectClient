...
extension AppStoreConnect.UserInvitations {
  ...
  public enum UserInvitationsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "userInvitations-get_instance", tag: "UserInvitations", method: "GET",
      path: "/v1/userInvitations/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsuserInvitations: [ASCFieldsuserInvitations]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsuserInvitations: fieldsuserInvitations, include: include,
