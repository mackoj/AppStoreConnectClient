...
extension AppStoreConnect.UserInvitations {
    ...
    public enum UserInvitationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "userInvitations-get_instance", tag: "UserInvitations", method: "GET", path: "/v1/userInvitations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsuserInvitations: [ASCFieldsuserInvitations]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsuserInvitations: [ASCFieldsuserInvitations]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitvisibleApps: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCUserInvitationResponse

            /** Single UserInvitation */
            case status200(ASCUserInvitationResponse)
            ...
            public var success: ASCUserInvitationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCUserInvitationResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCUserInvitationResponse.self, from: data))
