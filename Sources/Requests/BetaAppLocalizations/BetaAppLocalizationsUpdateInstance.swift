...
extension AppStoreConnect.BetaAppLocalizations {
  ...
  public enum BetaAppLocalizationsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaAppLocalizations-update_instance", tag: "BetaAppLocalizations", method: "PATCH",
      path: "/v1/betaAppLocalizations/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBetaAppLocalizationUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBetaAppLocalizationResponse.self, from: data))
