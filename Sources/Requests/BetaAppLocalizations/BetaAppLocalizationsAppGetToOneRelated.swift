...
extension AppStoreConnect.BetaAppLocalizations {
    ...
    public enum BetaAppLocalizationsAppGetToOneRelated {

        public static let service = APIService<Response>(id: "betaAppLocalizations-app-get_to_one_related", tag: "BetaAppLocalizations", method: "GET", path: "/v1/betaAppLocalizations/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaAppLocalizationsAppGetToOneRelated.service)
            }
