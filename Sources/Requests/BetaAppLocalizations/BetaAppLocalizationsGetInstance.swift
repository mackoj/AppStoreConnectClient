...
extension AppStoreConnect.BetaAppLocalizations {
    ...
    public enum BetaAppLocalizationsGetInstance {

        public static let service = APIService<Response>(id: "betaAppLocalizations-get_instance", tag: "BetaAppLocalizations", method: "GET", path: "/v1/betaAppLocalizations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaAppLocalizationsGetInstance.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                let options = Options(id: id, fieldsbetaAppLocalizations: fieldsbetaAppLocalizations, include: include, fieldsapps: fieldsapps)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBetaAppLocalizationResponse

            /** Single BetaAppLocalization */
            case status200(ASCBetaAppLocalizationResponse)
            ...
            public var success: ASCBetaAppLocalizationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBetaAppLocalizationResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaAppLocalizationResponse.self, from: data))
