...
extension AppStoreConnect.BetaAppLocalizations {
  ...
  public enum BetaAppLocalizationsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaAppLocalizations-get_instance", tag: "BetaAppLocalizations", method: "GET",
      path: "/v1/betaAppLocalizations/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaAppLocalizations: fieldsbetaAppLocalizations, include: include,
