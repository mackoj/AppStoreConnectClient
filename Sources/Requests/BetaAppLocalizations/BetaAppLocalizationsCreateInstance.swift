...
extension AppStoreConnect.BetaAppLocalizations {
  ...
  public enum BetaAppLocalizationsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "betaAppLocalizations-create_instance", tag: "BetaAppLocalizations", method: "POST",
      path: "/v1/betaAppLocalizations", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCBetaAppLocalizationResponse.self, from: data))
