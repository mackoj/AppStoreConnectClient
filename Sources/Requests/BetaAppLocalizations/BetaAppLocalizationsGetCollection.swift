...
extension AppStoreConnect.BetaAppLocalizations {
    ...
    public enum BetaAppLocalizationsGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaAppLocalizations-get_collection", tag: "BetaAppLocalizations", method: "GET", path: "/v1/betaAppLocalizations", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterlocale: [String]? = nil, filterapp: [String]? = nil, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
            ...
            public convenience init(filterlocale: [String]? = nil, filterapp: [String]? = nil, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsapps: [ASCFieldsapps]? = nil) {
                let options = Options(filterlocale: filterlocale, filterapp: filterapp, fieldsbetaAppLocalizations: fieldsbetaAppLocalizations, limit: limit, include: include, fieldsapps: fieldsapps)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<ASCBetaAppLocalizationsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBetaAppLocalizationsResponse.self, from: data))
