...
extension AppStoreConnect.BetaAppLocalizations {
    ...
    public enum BetaAppLocalizationsDeleteInstance {

        public static let service = APIService<Response>(id: "betaAppLocalizations-delete_instance", tag: "BetaAppLocalizations", method: "DELETE", path: "/v1/betaAppLocalizations/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BetaAppLocalizationsDeleteInstance.service)
            }
