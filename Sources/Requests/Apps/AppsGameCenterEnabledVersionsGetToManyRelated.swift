...
extension AppStoreConnect.Apps {
    ...
    public enum AppsGameCenterEnabledVersionsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-gameCenterEnabledVersions-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/gameCenterEnabledVersions", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, filterplatform: [ASCFilterplatform]? = nil, filterversionString: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsgameCenterEnabledVersions: [ASCFieldsgameCenterEnabledVersions]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, filterplatform: [ASCFilterplatform]? = nil, filterversionString: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil, fieldsgameCenterEnabledVersions: [ASCFieldsgameCenterEnabledVersions]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
