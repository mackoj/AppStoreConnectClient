...
extension AppStoreConnect.Apps {
  ...
  public enum AppsGameCenterEnabledVersionsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-gameCenterEnabledVersions-get_to_many_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/gameCenterEnabledVersions", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          ...
          filterversionString: [String]? = nil, filterid: [String]? = nil, sort: [ASCSort]? = nil,
