...
extension AppStoreConnect.Apps {
    ...
    public enum AppsPreOrderGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "apps-preOrder-get_to_one_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/preOrder", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPreOrders: [ASCFieldsappPreOrders]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPreOrders: [ASCFieldsappPreOrders]? = nil) {
