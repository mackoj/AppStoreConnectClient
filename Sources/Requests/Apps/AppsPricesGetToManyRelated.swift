...
extension AppStoreConnect.Apps {
  ...
  public enum AppsPricesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-prices-get_to_many_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/prices", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPrices: [ASCFieldsappPrices]? = nil,
          fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil, fieldsapps: [ASCFieldsapps]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappPrices: fieldsappPrices, fieldsappPriceTiers: fieldsappPriceTiers,
