...
extension AppStoreConnect.Apps {
    ...
    public enum AppsPricesGetToManyRelated {

        public static let service = APIService<Response>(id: "apps-prices-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/prices", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public enum ASCFieldsappPriceTiers: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** the fields to include for returned resources of type appPriceTiers */
                public var fieldsappPriceTiers: [ASCFieldsappPriceTiers]?
                ...
                public init(id: String, fieldsappPrices: [ASCFieldsappPrices]? = nil, fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsPricesGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsappPrices: [ASCFieldsappPrices]? = nil, fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                let options = Options(id: id, fieldsappPrices: fieldsappPrices, fieldsappPriceTiers: fieldsappPriceTiers, fieldsapps: fieldsapps, limit: limit, include: include)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPricesResponse

            /** List of related resources */
            case status200(ASCAppPricesResponse)
            ...
            public var success: ASCAppPricesResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPricesResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPricesResponse.self, from: data))
