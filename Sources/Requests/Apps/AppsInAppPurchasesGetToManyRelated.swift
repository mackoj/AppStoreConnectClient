...
extension AppStoreConnect.Apps {
  ...
  public enum AppsInAppPurchasesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-inAppPurchases-get_to_many_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/inAppPurchases", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, filterinAppPurchaseType: [ASCFilterinAppPurchaseType]? = nil,
          filtercanBeSubmitted: [String]? = nil, sort: [ASCSort]? = nil,
      ...
      public convenience init(
        id: String, filterinAppPurchaseType: [ASCFilterinAppPurchaseType]? = nil,
        filtercanBeSubmitted: [String]? = nil, sort: [ASCSort]? = nil,
        fieldsinAppPurchases: [ASCFieldsinAppPurchases]? = nil, fieldsapps: [ASCFieldsapps]? = nil,
        limit: Int? = nil, include: [ASCInclude]? = nil
      ) {
        let options = Options(
          id: id, filterinAppPurchaseType: filterinAppPurchaseType,
          filtercanBeSubmitted: filtercanBeSubmitted, sort: sort,
          fieldsinAppPurchases: fieldsinAppPurchases, fieldsapps: fieldsapps, limit: limit,
          include: include)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterinAppPurchaseType = options.filterinAppPurchaseType?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
