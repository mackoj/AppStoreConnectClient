...
extension AppStoreConnect.Apps {
  ...
  public enum AppsBetaTestersDeleteToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "apps-betaTesters-delete_to_many_relationship", tag: "Apps", method: "DELETE",
      path: "/v1/apps/{id}/relationships/betaTesters", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppBetaTestersLinkagesRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
