...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBetaTestersDeleteToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "apps-betaTesters-delete_to_many_relationship", tag: "Apps", method: "DELETE", path: "/v1/apps/{id}/relationships/betaTesters", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppBetaTestersLinkagesRequest

            public init(body: ASCAppBetaTestersLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppBetaTestersLinkagesRequest) {
