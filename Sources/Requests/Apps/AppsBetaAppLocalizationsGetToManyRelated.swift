...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBetaAppLocalizationsGetToManyRelated {

        public static let service = APIService<Response>(id: "apps-betaAppLocalizations-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/betaAppLocalizations", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsBetaAppLocalizationsGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbetaAppLocalizations: [ASCFieldsbetaAppLocalizations]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsbetaAppLocalizations: fieldsbetaAppLocalizations, limit: limit)
