...
extension AppStoreConnect.Apps {
  ...
  public enum AppsBetaAppLocalizationsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-betaAppLocalizations-get_to_many_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/betaAppLocalizations", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbetaAppLocalizations: fieldsbetaAppLocalizations, limit: limit)
