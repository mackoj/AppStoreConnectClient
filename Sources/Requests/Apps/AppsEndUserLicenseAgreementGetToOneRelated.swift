...
extension AppStoreConnect.Apps {
  ...
  public enum AppsEndUserLicenseAgreementGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-endUserLicenseAgreement-get_to_one_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/endUserLicenseAgreement", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsendUserLicenseAgreements: fieldsendUserLicenseAgreements)
