...
extension AppStoreConnect.Apps {
    ...
    public enum AppsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "apps-update_instance", tag: "Apps", method: "PATCH", path: "/v1/apps/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppUpdateRequest

            public init(body: ASCAppUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: AppsUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCAppUpdateRequest) {
