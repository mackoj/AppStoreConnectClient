...
extension AppStoreConnect.Apps {
  ...
  public enum AppsBetaLicenseAgreementGetToOneRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-betaLicenseAgreement-get_to_one_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/betaLicenseAgreement", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbetaLicenseAgreements: [ASCFieldsbetaLicenseAgreements]? = nil
        ) {
          self.id = id
