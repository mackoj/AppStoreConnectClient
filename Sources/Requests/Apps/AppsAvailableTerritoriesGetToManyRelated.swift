...
extension AppStoreConnect.Apps {
  ...
  public enum AppsAvailableTerritoriesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-availableTerritories-get_to_many_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/availableTerritories", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsterritories: [ASCFieldsterritories]? = nil, limit: Int? = nil
      ) {
