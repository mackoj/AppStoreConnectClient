...
extension AppStoreConnect.Apps {
    ...
    public enum AppsAppInfosGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-appInfos-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/appInfos", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappInfos: [ASCFieldsappInfos]? = nil, fieldsappCategories: [ASCFieldsappCategories]? = nil, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappInfos: [ASCFieldsappInfos]? = nil, fieldsappCategories: [ASCFieldsappCategories]? = nil, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                let options = Options(id: id, fieldsappInfos: fieldsappInfos, fieldsappCategories: fieldsappCategories, fieldsappInfoLocalizations: fieldsappInfoLocalizations, fieldsapps: fieldsapps, limit: limit, include: include)
