...
extension AppStoreConnect.Apps {
  ...
  public enum AppsPreReleaseVersionsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "apps-preReleaseVersions-get_to_many_related", tag: "Apps", method: "GET",
      path: "/v1/apps/{id}/preReleaseVersions", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldspreReleaseVersions: [ASCFieldspreReleaseVersions]? = nil,
          limit: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldspreReleaseVersions: fieldspreReleaseVersions, limit: limit)
