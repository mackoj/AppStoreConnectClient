...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBetaGroupsGetToManyRelated {

        public static let service = APIService<Response>(id: "apps-betaGroups-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/betaGroups", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsBetaGroupsGetToManyRelated.service)
            }
