...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBetaAppReviewDetailGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "apps-betaAppReviewDetail-get_to_one_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/betaAppReviewDetail", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaAppReviewDetails: [ASCFieldsbetaAppReviewDetails]? = nil) {
