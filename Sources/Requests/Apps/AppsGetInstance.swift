...
extension AppStoreConnect.Apps {
  ...
  public enum AppsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "apps-get_instance", tag: "Apps", method: "GET", path: "/v1/apps/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsapps: [ASCFieldsapps]? = nil, include: [ASCInclude]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsapps: fieldsapps, include: include, fieldsbetaGroups: fieldsbetaGroups,
          fieldsperfPowerMetrics: fieldsperfPowerMetrics, fieldsappInfos: fieldsappInfos,
          fieldsappPreOrders: fieldsappPreOrders,
