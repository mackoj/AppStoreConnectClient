...
extension AppStoreConnect.Apps {
    ...
    public enum AppsPerfPowerMetricsGetToManyRelated {

        public static let service = APIService<Response>(id: "apps-perfPowerMetrics-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/perfPowerMetrics", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, filterdeviceType: [String]? = nil, filtermetricType: [ASCFiltermetricType]? = nil, filterplatform: [ASCFilterplatform]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsPerfPowerMetricsGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, filterdeviceType: [String]? = nil, filtermetricType: [ASCFiltermetricType]? = nil, filterplatform: [ASCFilterplatform]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCPerfPowerMetricsResponse.self, from: data))
