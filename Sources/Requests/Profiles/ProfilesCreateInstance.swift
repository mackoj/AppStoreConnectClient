...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesCreateInstance {
        ...
        public static let service = APIService<Response>(id: "profiles-create_instance", tag: "Profiles", method: "POST", path: "/v1/profiles", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCProfileCreateRequest

            public init(body: ASCProfileCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: ProfilesCreateInstance.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single Profile */
            case status201(ASCProfileResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCProfileResponse.self, from: data))
