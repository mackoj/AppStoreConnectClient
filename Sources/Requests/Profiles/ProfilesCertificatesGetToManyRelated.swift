...
extension AppStoreConnect.Profiles {
  ...
  public enum ProfilesCertificatesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "profiles-certificates-get_to_many_related", tag: "Profiles", method: "GET",
      path: "/v1/profiles/{id}/certificates", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldscertificates: [ASCFieldscertificates]? = nil, limit: Int? = nil
        ) {
          self.id = id
