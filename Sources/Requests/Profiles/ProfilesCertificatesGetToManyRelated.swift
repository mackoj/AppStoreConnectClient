...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesCertificatesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "profiles-certificates-get_to_many_related", tag: "Profiles", method: "GET", path: "/v1/profiles/{id}/certificates", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldscertificates: [ASCFieldscertificates]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: ProfilesCertificatesGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldscertificates: [ASCFieldscertificates]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldscertificates: fieldscertificates, limit: limit)
