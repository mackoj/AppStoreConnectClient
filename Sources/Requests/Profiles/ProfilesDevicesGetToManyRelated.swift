...
extension AppStoreConnect.Profiles {
  ...
  public enum ProfilesDevicesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "profiles-devices-get_to_many_related", tag: "Profiles", method: "GET",
      path: "/v1/profiles/{id}/devices", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsdevices: [ASCFieldsdevices]? = nil, limit: Int? = nil
      ) {
