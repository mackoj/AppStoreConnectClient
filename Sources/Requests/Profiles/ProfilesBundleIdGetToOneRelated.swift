...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesBundleIdGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "profiles-bundleId-get_to_one_related", tag: "Profiles", method: "GET", path: "/v1/profiles/{id}/bundleId", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbundleIds: [ASCFieldsbundleIds]? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: ProfilesBundleIdGetToOneRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsbundleIds: [ASCFieldsbundleIds]? = nil) {
                let options = Options(id: id, fieldsbundleIds: fieldsbundleIds)
