...
extension AppStoreConnect.Profiles {
  ...
  public enum ProfilesGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "profiles-get_collection", tag: "Profiles", method: "GET", path: "/v1/profiles",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filtername: [String]? = nil, filterprofileState: [ASCFilterprofileState]? = nil,
          filterprofileType: [ASCFilterprofileType]? = nil, filterid: [String]? = nil,
          sort: [ASCSort]? = nil, fieldsprofiles: [ASCFieldsprofiles]? = nil, limit: Int? = nil,
          include: [ASCInclude]? = nil, fieldscertificates: [ASCFieldscertificates]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          ...
          filterprofileType: filterprofileType, filterid: filterid, sort: sort,
          fieldsprofiles: fieldsprofiles, limit: limit, include: include,
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let filterprofileState = options.filterprofileState?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
          params["filter[profileState]"] = filterprofileState
        }
        if let filterprofileType = options.filterprofileType?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
