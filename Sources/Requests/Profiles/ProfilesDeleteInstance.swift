...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "profiles-delete_instance", tag: "Profiles", method: "DELETE", path: "/v1/profiles/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProfilesDeleteInstance.service)
            }
