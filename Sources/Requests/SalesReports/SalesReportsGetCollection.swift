...
extension AppStoreConnect.SalesReports {
    ...
    public enum SalesReportsGetCollection {
        ...
        public static let service = APIService<Response>(id: "salesReports-get_collection", tag: "SalesReports", method: "GET", path: "/v1/salesReports", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        /** filter by attribute 'frequency' */
        public enum ASCFilterfrequency: String, Codable, Equatable, CaseIterable {
            case daily = "DAILY"
            case weekly = "WEEKLY"
        ...
        public enum ASCFilterreportSubType: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** filter by attribute 'frequency' */
                public var filterfrequency: [ASCFilterfrequency]

                /** filter by attribute 'reportDate' */
                public var filterreportDate: [String]?

                /** filter by attribute 'reportSubType' */
                public var filterreportSubType: [ASCFilterreportSubType]
                ...
                public init(filterfrequency: [ASCFilterfrequency], filterreportDate: [String]? = nil, filterreportSubType: [ASCFilterreportSubType], filterreportType: [ASCFilterreportType], filtervendorNumber: [String], filterversion: [String]? = nil) {
            ...
            public convenience init(filterfrequency: [ASCFilterfrequency], filterreportDate: [String]? = nil, filterreportSubType: [ASCFilterreportSubType], filterreportType: [ASCFilterreportType], filtervendorNumber: [String], filterversion: [String]? = nil) {
