...
extension AppStoreConnect.SalesReports {
  ...
  public enum SalesReportsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "salesReports-get_collection", tag: "SalesReports", method: "GET",
      path: "/v1/salesReports", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterfrequency: [ASCFilterfrequency], filterreportDate: [String]? = nil,
          filterreportSubType: [ASCFilterreportSubType], filterreportType: [ASCFilterreportType],
          filtervendorNumber: [String], filterversion: [String]? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filterfrequency: filterfrequency, filterreportDate: filterreportDate,
          filterreportSubType: filterreportSubType, filterreportType: filterreportType,
          filtervendorNumber: filtervendorNumber, filterversion: filterversion)
        self.init(options: options)
      }

      public override var queryParameters: [String: Any] {
        var params: [String: Any] = [:]
        params["filter[frequency]"] = options.filterfrequency.encode().map({
          String(describing: $0)
        }).joined(separator: ",")
        if let filterreportDate = options.filterreportDate?.joined(separator: ",") {
          params["filter[reportDate]"] = filterreportDate
        }
        params["filter[reportSubType]"] = options.filterreportSubType.encode().map({
          String(describing: $0)
        }).joined(separator: ",")
