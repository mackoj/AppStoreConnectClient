...
extension AppStoreConnect.AppStoreReviewDetails {
  ...
  public enum AppStoreReviewDetailsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreReviewDetails-update_instance", tag: "AppStoreReviewDetails", method: "PATCH",
      path: "/v1/appStoreReviewDetails/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppStoreReviewDetailUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppStoreReviewDetailResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCAppStoreReviewDetailResponse.self, from: data))
