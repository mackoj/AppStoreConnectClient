...
extension AppStoreConnect.AppStoreReviewDetails {
    ...
    public enum AppStoreReviewDetailsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewDetails-update_instance", tag: "AppStoreReviewDetails", method: "PATCH", path: "/v1/appStoreReviewDetails/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppStoreReviewDetailUpdateRequest

            public init(body: ASCAppStoreReviewDetailUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppStoreReviewDetailUpdateRequest) {
