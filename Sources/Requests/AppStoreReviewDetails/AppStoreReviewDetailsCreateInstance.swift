...
extension AppStoreConnect.AppStoreReviewDetails {
  ...
  public enum AppStoreReviewDetailsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreReviewDetails-create_instance", tag: "AppStoreReviewDetails", method: "POST",
      path: "/v1/appStoreReviewDetails", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCAppStoreReviewDetailResponse.self, from: data))
