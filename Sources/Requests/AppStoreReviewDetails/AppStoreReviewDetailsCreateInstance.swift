...
extension AppStoreConnect.AppStoreReviewDetails {
    ...
    public enum AppStoreReviewDetailsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewDetails-create_instance", tag: "AppStoreReviewDetails", method: "POST", path: "/v1/appStoreReviewDetails", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppStoreReviewDetailCreateRequest

            public init(body: ASCAppStoreReviewDetailCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppStoreReviewDetailResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppStoreReviewDetailResponse.self, from: data))
