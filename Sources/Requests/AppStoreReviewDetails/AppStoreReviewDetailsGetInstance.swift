...
extension AppStoreConnect.AppStoreReviewDetails {
  ...
  public enum AppStoreReviewDetailsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appStoreReviewDetails-get_instance", tag: "AppStoreReviewDetails", method: "GET",
      path: "/v1/appStoreReviewDetails/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          ...
          limitappStoreReviewAttachments: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappStoreReviewDetails: fieldsappStoreReviewDetails, include: include,
