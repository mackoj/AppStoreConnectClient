...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsGetInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIds-get_instance", tag: "BundleIds", method: "GET", path: "/v1/bundleIds/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbundleIds: [ASCFieldsbundleIds]? = nil, include: [ASCInclude]? = nil, fieldsbundleIdCapabilities: [ASCFieldsbundleIdCapabilities]? = nil, fieldsprofiles: [ASCFieldsprofiles]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitbundleIdCapabilities: Int? = nil, limitprofiles: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbundleIds: [ASCFieldsbundleIds]? = nil, include: [ASCInclude]? = nil, fieldsbundleIdCapabilities: [ASCFieldsbundleIdCapabilities]? = nil, fieldsprofiles: [ASCFieldsprofiles]? = nil, fieldsapps: [ASCFieldsapps]? = nil, limitbundleIdCapabilities: Int? = nil, limitprofiles: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBundleIdResponse

            /** Single BundleId */
            case status200(ASCBundleIdResponse)
            ...
            public var success: ASCBundleIdResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBundleIdResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBundleIdResponse.self, from: data))
