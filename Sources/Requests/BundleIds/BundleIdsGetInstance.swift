...
extension AppStoreConnect.BundleIds {
  ...
  public enum BundleIdsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "bundleIds-get_instance", tag: "BundleIds", method: "GET", path: "/v1/bundleIds/{id}",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbundleIds: [ASCFieldsbundleIds]? = nil, include: [ASCInclude]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbundleIds: fieldsbundleIds, include: include,
