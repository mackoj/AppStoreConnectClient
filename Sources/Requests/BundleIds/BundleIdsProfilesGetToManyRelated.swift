...
extension AppStoreConnect.BundleIds {
  ...
  public enum BundleIdsProfilesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "bundleIds-profiles-get_to_many_related", tag: "BundleIds", method: "GET",
      path: "/v1/bundleIds/{id}/profiles", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        id: String, fieldsprofiles: [ASCFieldsprofiles]? = nil, limit: Int? = nil
      ) {
