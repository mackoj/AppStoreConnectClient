...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsProfilesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "bundleIds-profiles-get_to_many_related", tag: "BundleIds", method: "GET", path: "/v1/bundleIds/{id}/profiles", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsprofiles: [ASCFieldsprofiles]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: BundleIdsProfilesGetToManyRelated.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, fieldsprofiles: [ASCFieldsprofiles]? = nil, limit: Int? = nil) {
                let options = Options(id: id, fieldsprofiles: fieldsprofiles, limit: limit)
