...
extension AppStoreConnect.BundleIds {
  ...
  public enum BundleIdsBundleIdCapabilitiesGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "bundleIds-bundleIdCapabilities-get_to_many_related", tag: "BundleIds", method: "GET",
      path: "/v1/bundleIds/{id}/bundleIdCapabilities", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsbundleIdCapabilities: [ASCFieldsbundleIdCapabilities]? = nil,
          limit: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbundleIdCapabilities: fieldsbundleIdCapabilities, limit: limit)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBundleIdCapabilitiesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBundleIdCapabilitiesResponse.self, from: data))
