...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIds-delete_instance", tag: "BundleIds", method: "DELETE", path: "/v1/bundleIds/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BundleIdsDeleteInstance.service)
            }
