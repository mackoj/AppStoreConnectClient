...
extension AppStoreConnect.BundleIds {
  ...
  public enum BundleIdsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "bundleIds-get_collection", tag: "BundleIds", method: "GET", path: "/v1/bundleIds",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filteridentifier: [String]? = nil, filtername: [String]? = nil,
          filterplatform: [ASCFilterplatform]? = nil, filterseedId: [String]? = nil,
          filterid: [String]? = nil, sort: [ASCSort]? = nil,
          fieldsbundleIds: [ASCFieldsbundleIds]? = nil, limit: Int? = nil,
          include: [ASCInclude]? = nil,
          fieldsbundleIdCapabilities: [ASCFieldsbundleIdCapabilities]? = nil,
          fieldsprofiles: [ASCFieldsprofiles]? = nil, fieldsapps: [ASCFieldsapps]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          filteridentifier: filteridentifier, filtername: filtername,
          filterplatform: filterplatform, filterseedId: filterseedId, filterid: filterid,
          sort: sort, fieldsbundleIds: fieldsbundleIds, limit: limit, include: include,
          fieldsbundleIdCapabilities: fieldsbundleIdCapabilities, fieldsprofiles: fieldsprofiles,
          fieldsapps: fieldsapps, limitbundleIdCapabilities: limitbundleIdCapabilities,
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let fieldsbundleIdCapabilities = options.fieldsbundleIdCapabilities?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
