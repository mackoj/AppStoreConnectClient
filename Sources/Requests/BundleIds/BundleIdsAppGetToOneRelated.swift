...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "bundleIds-app-get_to_one_related", tag: "BundleIds", method: "GET", path: "/v1/bundleIds/{id}/app", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BundleIdsAppGetToOneRelated.service)
            }
