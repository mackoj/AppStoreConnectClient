...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIds-update_instance", tag: "BundleIds", method: "PATCH", path: "/v1/bundleIds/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCBundleIdUpdateRequest

            public init(body: ASCBundleIdUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: BundleIdsUpdateInstance.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: String, body: ASCBundleIdUpdateRequest) {
