...
extension AppStoreConnect.AppPricePoints {
  ...
  public enum AppPricePointsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "appPricePoints-get_collection", tag: "AppPricePoints", method: "GET",
      path: "/v1/appPricePoints", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterpriceTier: [String]? = nil, filterterritory: [String]? = nil,
          fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limit: Int? = nil,
          include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filterpriceTier: filterpriceTier, filterterritory: filterterritory,
          fieldsappPricePoints: fieldsappPricePoints, limit: limit, include: include,
