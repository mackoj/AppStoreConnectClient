...
extension AppStoreConnect.AppPricePoints {
    ...
    public enum AppPricePointsGetCollection {
        ...
        public static let service = APIService<Response>(id: "appPricePoints-get_collection", tag: "AppPricePoints", method: "GET", path: "/v1/appPricePoints", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterpriceTier: [String]? = nil, filterterritory: [String]? = nil, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil) {
            ...
            public convenience init(filterpriceTier: [String]? = nil, filterterritory: [String]? = nil, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPricePointsResponse

            /** List of AppPricePoints */
            case status200(ASCAppPricePointsResponse)
            ...
            public var success: ASCAppPricePointsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPricePointsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPricePointsResponse.self, from: data))
