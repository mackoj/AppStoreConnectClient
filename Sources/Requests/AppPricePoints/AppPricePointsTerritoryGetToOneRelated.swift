...
extension AppStoreConnect.AppPricePoints {
    ...
    public enum AppPricePointsTerritoryGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appPricePoints-territory-get_to_one_related", tag: "AppPricePoints", method: "GET", path: "/v1/appPricePoints/{id}/territory", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsterritories: [ASCFieldsterritories]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsterritories: [ASCFieldsterritories]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCTerritoryResponse

            /** Related resource */
            case status200(ASCTerritoryResponse)
            ...
            public var success: ASCTerritoryResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCTerritoryResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCTerritoryResponse.self, from: data))
