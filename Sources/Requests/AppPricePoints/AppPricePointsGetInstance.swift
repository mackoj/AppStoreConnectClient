...
extension AppStoreConnect.AppPricePoints {
  ...
  public enum AppPricePointsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPricePoints-get_instance", tag: "AppPricePoints", method: "GET",
      path: "/v1/appPricePoints/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappPricePoints: fieldsappPricePoints, include: include,
