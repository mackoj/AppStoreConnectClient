...
extension AppStoreConnect.AppPricePoints {
    ...
    public enum AppPricePointsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appPricePoints-get_instance", tag: "AppPricePoints", method: "GET", path: "/v1/appPricePoints/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, include: [ASCInclude]? = nil, fieldsterritories: [ASCFieldsterritories]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPricePointResponse

            /** Single AppPricePoint */
            case status200(ASCAppPricePointResponse)
            ...
            public var success: ASCAppPricePointResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPricePointResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPricePointResponse.self, from: data))
