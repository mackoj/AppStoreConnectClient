...
extension AppStoreConnect.AppPriceTiers {
  ...
  public enum AppPriceTiersPricePointsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "appPriceTiers-pricePoints-get_to_many_related", tag: "AppPriceTiers", method: "GET",
      path: "/v1/appPriceTiers/{id}/pricePoints", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limit: Int? = nil
        ) {
          self.id = id
