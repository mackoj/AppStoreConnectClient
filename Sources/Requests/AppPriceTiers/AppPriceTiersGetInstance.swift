...
extension AppStoreConnect.AppPriceTiers {
  ...
  public enum AppPriceTiersGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPriceTiers-get_instance", tag: "AppPriceTiers", method: "GET",
      path: "/v1/appPriceTiers/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil,
          include: [ASCInclude]? = nil, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil,
          limitpricePoints: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappPriceTiers: fieldsappPriceTiers, include: include,
          fieldsappPricePoints: fieldsappPricePoints, limitpricePoints: limitpricePoints)
      ...
      public override var queryParameters: [String: Any] {
        ...
        if let fieldsappPriceTiers = options.fieldsappPriceTiers?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
        ...
        if let fieldsappPricePoints = options.fieldsappPricePoints?.encode().map({
          String(describing: $0)
        }).joined(separator: ",") {
