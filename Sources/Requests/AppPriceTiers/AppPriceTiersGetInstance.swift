...
extension AppStoreConnect.AppPriceTiers {
    ...
    public enum AppPriceTiersGetInstance {
        ...
        public static let service = APIService<Response>(id: "appPriceTiers-get_instance", tag: "AppPriceTiers", method: "GET", path: "/v1/appPriceTiers/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil, include: [ASCInclude]? = nil, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limitpricePoints: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil, include: [ASCInclude]? = nil, fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limitpricePoints: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPriceTierResponse

            /** Single AppPriceTier */
            case status200(ASCAppPriceTierResponse)
            ...
            public var success: ASCAppPriceTierResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPriceTierResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPriceTierResponse.self, from: data))
