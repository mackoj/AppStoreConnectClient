...
extension AppStoreConnect.AppPriceTiers {
  ...
  public enum AppPriceTiersGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "appPriceTiers-get_collection", tag: "AppPriceTiers", method: "GET",
      path: "/v1/appPriceTiers", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterid: [String]? = nil, fieldsappPriceTiers: [ASCFieldsappPriceTiers]? = nil,
          limit: Int? = nil, include: [ASCInclude]? = nil,
          fieldsappPricePoints: [ASCFieldsappPricePoints]? = nil, limitpricePoints: Int? = nil
        ) {
      ...
      public convenience init(
        ...
        let options = Options(
          filterid: filterid, fieldsappPriceTiers: fieldsappPriceTiers, limit: limit,
          include: include, fieldsappPricePoints: fieldsappPricePoints,
