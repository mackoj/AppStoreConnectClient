...
extension AppStoreConnect.BuildBetaDetails {
  ...
  public enum BuildBetaDetailsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "buildBetaDetails-get_instance", tag: "BuildBetaDetails", method: "GET",
      path: "/v1/buildBetaDetails/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsbuildBetaDetails: fieldsbuildBetaDetails, include: include,
