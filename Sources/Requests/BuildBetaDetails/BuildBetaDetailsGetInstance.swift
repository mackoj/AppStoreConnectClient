...
extension AppStoreConnect.BuildBetaDetails {
    ...
    public enum BuildBetaDetailsGetInstance {
        ...
        public static let service = APIService<Response>(id: "buildBetaDetails-get_instance", tag: "BuildBetaDetails", method: "GET", path: "/v1/buildBetaDetails/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
