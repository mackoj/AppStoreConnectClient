...
extension AppStoreConnect.BuildBetaDetails {
    ...
    public enum BuildBetaDetailsBuildGetToOneRelated {

        public static let service = APIService<Response>(id: "buildBetaDetails-build-get_to_one_related", tag: "BuildBetaDetails", method: "GET", path: "/v1/buildBetaDetails/{id}/build", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildBetaDetailsBuildGetToOneRelated.service)
            }
