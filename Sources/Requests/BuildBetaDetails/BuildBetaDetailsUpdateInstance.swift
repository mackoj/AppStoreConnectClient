...
extension AppStoreConnect.BuildBetaDetails {
  ...
  public enum BuildBetaDetailsUpdateInstance {
    ...
    public static let service = APIService<Response>(
      id: "buildBetaDetails-update_instance", tag: "BuildBetaDetails", method: "PATCH",
      path: "/v1/buildBetaDetails/{id}", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCBuildBetaDetailUpdateRequest, options: Options, encoder: RequestEncoder? = nil
      ) {
        self.body = body
