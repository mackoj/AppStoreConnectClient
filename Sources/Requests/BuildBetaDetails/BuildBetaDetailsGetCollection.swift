...
extension AppStoreConnect.BuildBetaDetails {
  ...
  public enum BuildBetaDetailsGetCollection {
    ...
    public static let service = APIService<Response>(
      id: "buildBetaDetails-get_collection", tag: "BuildBetaDetails", method: "GET",
      path: "/v1/buildBetaDetails", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          filterbuild: [String]? = nil, filterid: [String]? = nil,
          fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil, limit: Int? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          filterbuild: filterbuild, filterid: filterid,
          fieldsbuildBetaDetails: fieldsbuildBetaDetails, limit: limit, include: include,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCBuildBetaDetailsResponse.self, from: data))
