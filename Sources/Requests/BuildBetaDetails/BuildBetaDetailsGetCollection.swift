...
extension AppStoreConnect.BuildBetaDetails {
    ...
    public enum BuildBetaDetailsGetCollection {
        ...
        public static let service = APIService<Response>(id: "buildBetaDetails-get_collection", tag: "BuildBetaDetails", method: "GET", path: "/v1/buildBetaDetails", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterbuild: [String]? = nil, filterid: [String]? = nil, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
            ...
            public convenience init(filterbuild: [String]? = nil, filterid: [String]? = nil, fieldsbuildBetaDetails: [ASCFieldsbuildBetaDetails]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil, fieldsbuilds: [ASCFieldsbuilds]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBuildBetaDetailsResponse

            /** List of BuildBetaDetails */
            case status200(ASCBuildBetaDetailsResponse)
            ...
            public var success: ASCBuildBetaDetailsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBuildBetaDetailsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCBuildBetaDetailsResponse.self, from: data))
