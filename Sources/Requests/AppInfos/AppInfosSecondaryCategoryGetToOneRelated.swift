...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosSecondaryCategoryGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-secondaryCategory-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/secondaryCategory", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
