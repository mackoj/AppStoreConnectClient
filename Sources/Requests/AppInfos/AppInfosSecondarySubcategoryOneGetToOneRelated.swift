...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosSecondarySubcategoryOneGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-secondarySubcategoryOne-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/secondarySubcategoryOne", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappCategories: [ASCFieldsappCategories]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappCategories: [ASCFieldsappCategories]? = nil) {
