...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosPrimarySubcategoryTwoGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-primarySubcategoryTwo-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/primarySubcategoryTwo", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
