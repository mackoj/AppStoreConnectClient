...
extension AppStoreConnect.AppInfos {
  ...
  public enum AppInfosAppInfoLocalizationsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "appInfos-appInfoLocalizations-get_to_many_related", tag: "AppInfos", method: "GET",
      path: "/v1/appInfos/{id}/appInfoLocalizations", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, filterlocale: [String]? = nil, fieldsappInfos: [ASCFieldsappInfos]? = nil,
          fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, limit: Int? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, filterlocale: filterlocale, fieldsappInfos: fieldsappInfos,
          fieldsappInfoLocalizations: fieldsappInfoLocalizations, limit: limit, include: include)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppInfoLocalizationsResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200:
          self = try .status200(decoder.decode(ASCAppInfoLocalizationsResponse.self, from: data))
