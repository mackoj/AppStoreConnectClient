...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosAppInfoLocalizationsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-appInfoLocalizations-get_to_many_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/appInfoLocalizations", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, filterlocale: [String]? = nil, fieldsappInfos: [ASCFieldsappInfos]? = nil, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, filterlocale: [String]? = nil, fieldsappInfos: [ASCFieldsappInfos]? = nil, fieldsappInfoLocalizations: [ASCFieldsappInfoLocalizations]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppInfoLocalizationsResponse

            /** List of related resources */
            case status200(ASCAppInfoLocalizationsResponse)
            ...
            public var success: ASCAppInfoLocalizationsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppInfoLocalizationsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppInfoLocalizationsResponse.self, from: data))
