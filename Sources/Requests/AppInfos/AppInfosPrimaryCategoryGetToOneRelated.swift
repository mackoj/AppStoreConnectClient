...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosPrimaryCategoryGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-primaryCategory-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/primaryCategory", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
