...
extension AppStoreConnect.AppInfos {
  ...
  public enum AppInfosGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appInfos-get_instance", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}",
    ...
    public final class Request: APIRequest<Response> {
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappInfos: fieldsappInfos, include: include,
