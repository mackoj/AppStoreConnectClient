...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosSecondarySubcategoryTwoGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-secondarySubcategoryTwo-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/secondarySubcategoryTwo", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
