...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appInfos-update_instance", tag: "AppInfos", method: "PATCH", path: "/v1/appInfos/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppInfoUpdateRequest

            public init(body: ASCAppInfoUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppInfoUpdateRequest) {
