...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosPrimarySubcategoryOneGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-primarySubcategoryOne-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/primarySubcategoryOne", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
