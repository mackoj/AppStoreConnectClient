...
extension AppStoreConnect.BuildBetaNotifications {
    ...
    public enum BuildBetaNotificationsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "buildBetaNotifications-create_instance", tag: "BuildBetaNotifications", method: "POST", path: "/v1/buildBetaNotifications", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCBuildBetaNotificationCreateRequest

            public init(body: ASCBuildBetaNotificationCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCBuildBetaNotificationResponse

            /** Single BuildBetaNotification */
            case status201(ASCBuildBetaNotificationResponse)
            ...
            public var success: ASCBuildBetaNotificationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCBuildBetaNotificationResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCBuildBetaNotificationResponse.self, from: data))
