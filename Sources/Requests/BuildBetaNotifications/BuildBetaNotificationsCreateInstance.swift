...
extension AppStoreConnect.BuildBetaNotifications {
  ...
  public enum BuildBetaNotificationsCreateInstance {
    ...
    public static let service = APIService<Response>(
      id: "buildBetaNotifications-create_instance", tag: "BuildBetaNotifications", method: "POST",
      path: "/v1/buildBetaNotifications", hasBody: true,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCBuildBetaNotificationResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 201:
          self = try .status201(decoder.decode(ASCBuildBetaNotificationResponse.self, from: data))
