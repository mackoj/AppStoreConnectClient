...
extension AppStoreConnect.FinanceReports {
    ...
    public enum FinanceReportsGetCollection {
        ...
        public static let service = APIService<Response>(id: "financeReports-get_collection", tag: "FinanceReports", method: "GET", path: "/v1/financeReports", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filterregionCode: [String], filterreportDate: [String], filterreportType: [ASCFilterreportType], filtervendorNumber: [String]) {
            ...
            public convenience init(filterregionCode: [String], filterreportDate: [String], filterreportType: [ASCFilterreportType], filtervendorNumber: [String]) {
