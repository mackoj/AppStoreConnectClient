...
extension AppStoreConnect.AppPreviewSets {
  ...
  public enum AppPreviewSetsAppPreviewsGetToManyRelated {
    ...
    public static let service = APIService<Response>(
      id: "appPreviewSets-appPreviews-get_to_many_related", tag: "AppPreviewSets", method: "GET",
      path: "/v1/appPreviewSets/{id}/appPreviews", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPreviews: [ASCFieldsappPreviews]? = nil,
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappPreviews: fieldsappPreviews, fieldsappPreviewSets: fieldsappPreviewSets,
