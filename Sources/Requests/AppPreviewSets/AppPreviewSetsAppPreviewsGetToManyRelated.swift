...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsAppPreviewsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-appPreviews-get_to_many_related", tag: "AppPreviewSets", method: "GET", path: "/v1/appPreviewSets/{id}/appPreviews", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, limit: Int? = nil, include: [ASCInclude]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPreviewsResponse

            /** List of related resources */
            case status200(ASCAppPreviewsResponse)
            ...
            public var success: ASCAppPreviewsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPreviewsResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPreviewsResponse.self, from: data))
