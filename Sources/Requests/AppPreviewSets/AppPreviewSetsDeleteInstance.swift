...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-delete_instance", tag: "AppPreviewSets", method: "DELETE", path: "/v1/appPreviewSets/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
