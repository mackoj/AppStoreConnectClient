...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsAppPreviewsGetToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-appPreviews-get_to_many_relationship", tag: "AppPreviewSets", method: "GET", path: "/v1/appPreviewSets/{id}/relationships/appPreviews", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPreviewSetAppPreviewsLinkagesResponse

            /** List of related linkages */
            case status200(ASCAppPreviewSetAppPreviewsLinkagesResponse)
            ...
            public var success: ASCAppPreviewSetAppPreviewsLinkagesResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPreviewSetAppPreviewsLinkagesResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPreviewSetAppPreviewsLinkagesResponse.self, from: data))
