...
extension AppStoreConnect.AppPreviewSets {
  ...
  public enum AppPreviewSetsAppPreviewsGetToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "appPreviewSets-appPreviews-get_to_many_relationship", tag: "AppPreviewSets",
      method: "GET", path: "/v1/appPreviewSets/{id}/relationships/appPreviews", hasBody: false,
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public var responseResult:
        APIResponseResult<ASCAppPreviewSetAppPreviewsLinkagesResponse, ASCErrorResponse>
      {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        ...
        case 200:
          self = try .status200(
            decoder.decode(ASCAppPreviewSetAppPreviewsLinkagesResponse.self, from: data))
