...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-get_instance", tag: "AppPreviewSets", method: "GET", path: "/v1/appPreviewSets/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, include: [ASCInclude]? = nil, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, limitappPreviews: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil, include: [ASCInclude]? = nil, fieldsappPreviews: [ASCFieldsappPreviews]? = nil, limitappPreviews: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ASCAppPreviewSetResponse

            /** Single AppPreviewSet */
            case status200(ASCAppPreviewSetResponse)
            ...
            public var success: ASCAppPreviewSetResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ASCAppPreviewSetResponse, ASCErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ASCAppPreviewSetResponse.self, from: data))
