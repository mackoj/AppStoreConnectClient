...
extension AppStoreConnect.AppPreviewSets {
  ...
  public enum AppPreviewSetsGetInstance {
    ...
    public static let service = APIService<Response>(
      id: "appPreviewSets-get_instance", tag: "AppPreviewSets", method: "GET",
      path: "/v1/appPreviewSets/{id}", hasBody: false,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Options {
        ...
        public init(
          id: String, fieldsappPreviewSets: [ASCFieldsappPreviewSets]? = nil,
          include: [ASCInclude]? = nil, fieldsappPreviews: [ASCFieldsappPreviews]? = nil,
          limitappPreviews: Int? = nil
        ) {
          self.id = id
      ...
      public convenience init(
        ...
        let options = Options(
          id: id, fieldsappPreviewSets: fieldsappPreviewSets, include: include,
          fieldsappPreviews: fieldsappPreviews, limitappPreviews: limitappPreviews)
