...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-create_instance", tag: "AppPreviewSets", method: "POST", path: "/v1/appPreviewSets", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))

        public final class Request: APIRequest<Response> {

            public var body: ASCAppPreviewSetCreateRequest

            public init(body: ASCAppPreviewSetCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            case status201(ASCAppPreviewSetResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ASCAppPreviewSetResponse.self, from: data))
