...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsAppPreviewsReplaceToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-appPreviews-replace_to_many_relationship", tag: "AppPreviewSets", method: "PATCH", path: "/v1/appPreviewSets/{id}/relationships/appPreviews", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAppPreviewSetAppPreviewsLinkagesRequest

            public init(body: ASCAppPreviewSetAppPreviewsLinkagesRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAppPreviewSetAppPreviewsLinkagesRequest) {
