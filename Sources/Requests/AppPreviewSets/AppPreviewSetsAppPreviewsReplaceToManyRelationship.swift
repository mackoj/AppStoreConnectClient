...
extension AppStoreConnect.AppPreviewSets {
  ...
  public enum AppPreviewSetsAppPreviewsReplaceToManyRelationship {
    ...
    public static let service = APIService<Response>(
      id: "appPreviewSets-appPreviews-replace_to_many_relationship", tag: "AppPreviewSets",
      method: "PATCH", path: "/v1/appPreviewSets/{id}/relationships/appPreviews", hasBody: true,
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(
        body: ASCAppPreviewSetAppPreviewsLinkagesRequest, options: Options,
        encoder: RequestEncoder? = nil
      ) {
        self.body = body
        self.options = options
        super.init(service: AppPreviewSetsAppPreviewsReplaceToManyRelationship.service) {
          defaultEncoder in
