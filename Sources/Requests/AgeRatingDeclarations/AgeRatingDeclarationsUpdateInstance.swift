...
extension AppStoreConnect.AgeRatingDeclarations {
    ...
    public enum AgeRatingDeclarationsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "ageRatingDeclarations-update_instance", tag: "AgeRatingDeclarations", method: "PATCH", path: "/v1/ageRatingDeclarations/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "itc-bearer-token", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ASCAgeRatingDeclarationUpdateRequest

            public init(body: ASCAgeRatingDeclarationUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: ASCAgeRatingDeclarationUpdateRequest) {
